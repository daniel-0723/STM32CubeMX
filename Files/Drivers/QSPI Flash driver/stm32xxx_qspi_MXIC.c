...
static uint32_t QSPI_SetODS(uint32_t Instance, uint8_t ODS);
#endif  // MXIC_SNOR_CR_ODS

#if defined(MXIC_SNOR_CR_DC) || defined(MXIC_SNOR_CR2_DC)
static uint32_t QSPI_DummyCyclesCfg(uint32_t Instance, uint8_t DCIndex);
#endif
...
/**
  ...
  * @retval BSP status
  */
uint32_t BSP_QSPI_Init(uint32_t Instance, BSP_QSPI_Init_t Init)
{
    ...
    if(BSP_QSPI_ResetMemory(Instance) != BSP_ERROR_NONE)
    {
...
/**
  ...
  * @retval BSP status
  */
uint32_t BSP_QSPI_DeInit(uint32_t Instance)
{
...
/**
  ...
  * @retval BSP status
  */
uint32_t BSP_QSPI_RegisterDefaultMspCallbacks (uint32_t Instance)
{
  uint32_t ret = BSP_ERROR_NONE;
...
/**
  ...
  * @retval BSP status
  */
uint32_t BSP_QSPI_RegisterMspCallbacks (uint32_t Instance, BSP_QSPI_Cb_t *CallBacks)
{
  uint32_t ret = BSP_ERROR_NONE;
...
/**
  ...
  * @retval BSP status
  */
uint32_t BSP_QSPI_GetInfo(uint32_t Instance, BSP_QSPI_Info_t *pInfo)
{
  uint32_t ret = BSP_ERROR_NONE;
...
/**
  ...
  */
uint32_t BSP_QSPI_GetStatus(uint32_t Instance)
{
  uint32_t ret;
  MXIC_SNOR_StatusRegister_t SReg;
...
/**
  ...
  * @retval BSP status
  */
uint32_t BSP_QSPI_SetFlashInterface(uint32_t Instance, BSP_QSPI_Init_t Init)
{
  uint32_t ret = BSP_ERROR_NONE;
...
/**
  ...
  */
uint32_t BSP_QSPI_GetFlashInterface(uint32_t Instance, BSP_QSPI_Init_t *pInit)
{
  uint32_t ret = BSP_ERROR_NONE;
...
/**
  ...
  * @retval BSP status
  */
uint32_t BSP_QSPI_EnableMemoryMappedMode(uint32_t Instance)
{
  uint32_t ret = BSP_ERROR_NONE;
...
/**
  ...
  * @retval BSP status
  */
uint32_t BSP_QSPI_DisableMemoryMappedMode(uint32_t Instance)
{
  uint32_t ret = BSP_ERROR_NONE;
...
/**
  ...
  */
uint32_t BSP_QSPI_ReadID(uint32_t Instance, uint32_t *pID)
{
  uint32_t ret = BSP_ERROR_NONE;
...
/**
  ...
  * @retval BSP status
  */
uint32_t BSP_QSPI_Read(uint32_t Instance, uint8_t *pData, uint32_t Address, uint32_t Size)
{
  uint32_t ret = BSP_ERROR_NONE;
...
/**
  ...
  * @retval BSP status
  */
uint32_t BSP_QSPI_Write(uint32_t Instance, uint8_t *pData, uint32_t Address, uint32_t Size)
{
  uint32_t ret = BSP_ERROR_NONE;
...
/**
  ...
  * @retval BSP status
  */
uint32_t BSP_QSPI_EraseBlock(uint32_t Instance, uint32_t Address, BSP_QSPI_Erase_t Size)
{
  uint32_t ret = BSP_ERROR_NONE;
...
/**
  ...
  * @retval BSP status
  */
uint32_t BSP_QSPI_EraseChip(uint32_t Instance)
{
  uint32_t ret = BSP_ERROR_NONE;
...
/**
  ...
  * @retval BSP status
  */
uint32_t BSP_QSPI_ReadStatusRegister(uint32_t Instance, MXIC_SNOR_StatusRegister_t *pData)
{
  uint32_t ret = BSP_ERROR_NONE;
...
/**
  ...
  * @retval BSP status
  */
uint32_t BSP_QSPI_WriteStatusRegister(uint32_t Instance, MXIC_SNOR_StatusRegister_t Data)
{
  uint32_t ret = BSP_ERROR_NONE;
...
/**
  ...
  * @retval BSP status
  */
uint32_t BSP_QSPI_ReadConfigurationRegister(uint32_t Instance, uint8_t *pData, uint32_t Size)
{
  uint32_t ret = BSP_ERROR_NONE;
...
/**
  ...
  * @retval BSP status
  */
uint32_t BSP_QSPI_WriteConfigurationRegister(uint32_t Instance, uint8_t *pData, uint32_t Size)
{
  uint32_t ret = BSP_ERROR_NONE;
...
/**
  ...
  *         *pData = CR2 value
  */
uint32_t BSP_QSPI_ReadConfigurationRegister2(uint32_t Instance, uint8_t *pData, uint32_t Address)
{
  uint32_t ret = BSP_ERROR_NONE;
...
/**
  ...
  * @retval BSP status
  */
uint32_t BSP_QSPI_WriteConfigurationRegister2(uint32_t Instance, uint8_t Data, uint32_t Address)
{
  uint32_t ret = BSP_ERROR_NONE;
...
/**
  ...
  * @retval BSP status
  */
uint32_t BSP_QSPI_ResetMemory(uint32_t Instance)
{
  uint32_t ret = BSP_ERROR_NONE;
