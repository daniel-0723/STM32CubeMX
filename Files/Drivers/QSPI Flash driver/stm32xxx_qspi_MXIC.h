...
#if (USE_HAL_QSPI_REGISTER_CALLBACKS == 1)
uint32_t BSP_QSPI_Register_QspiMspCallbacks (uint32_t Instance, pQSPI_CallbackTypeDef pMspInitCb, pQSPI_CallbackTypeDef pMspDeInitCb);
uint32_t BSP_QSPI_Register_DefaultMspCallbacks (uint32_t Instance);
#endif /* (USE_HAL_QSPI_REGISTER_CALLBACKS == 1) */
