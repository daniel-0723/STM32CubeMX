 ...
 * @file    MXIC_SNOR_512K.h
 * @brief   This file contains all information of Macronix 512K bit xSPI memory.
...
#ifndef __MXIC_SNOR_512K_H
#define __MXIC_SNOR_512K_H
 ...
 * 1.8V : MX25U5121E
 * 2.5V : MX25V512C, MX25V512E, MX25V512F, MX25V5126F
 * 3.3V : MX25L512C, MX25L512E, MX25L5121E
 * Wide Range :
 *        MX25R512F
 *************************************************************************************************/
#define MX25V5126F
...
#if defined(MX25V512C) || defined(MX25V512E) || defined(MX25V5126F) || \
    defined(MX25L512C) || defined(MX25L512E)
#define MXIC_SNOR_MEMORY_TYPE_ID            0x20
#elif defined(MX25L5121E)
#define MXIC_SNOR_MEMORY_TYPE_ID            0x22
#elif defined(MX25V512F)
#define MXIC_SNOR_MEMORY_TYPE_ID            0x23
#elif defined(MX25U5121E)
#define MXIC_SNOR_MEMORY_TYPE_ID            0x25
#elif defined(MX25R512F)
#define MXIC_SNOR_MEMORY_TYPE_ID            0x28
#endif

#if defined(MX25V512C) || defined(MX25V512E) || defined(MX25V512F)  || defined(MX25V5126F) || \
    defined(MX25L512C) || defined(MX25L512E) || defined(MX25L5121E) || \
    defined(MX25R512F)
#define MXIC_SNOR_MEMORY_CAPACITY_ID        0x10
#elif defined(MX25U5121E)
#define MXIC_SNOR_MEMORY_CAPACITY_ID        0x30
#endif
 ...
 *************************************************************************************************/
#define MXIC_SNOR_FLASH_SIZE                ((512U / 8U) * 1024U)           // 512K bit = 64K Byte
#if defined(MX25U5121E) || \
    defined(MX25L5121E)
...
#if defined(MX25V512E)
#define MXIC_SNOR_MAX_TIME_ERASE_CHIP       1000U
#elif defined(MX25U5121E)
#define MXIC_SNOR_MAX_TIME_ERASE_CHIP       1200U
#elif defined(MX25V512C) || \
      defined(MX25L512C) || defined(MX25L512E) || defined(MX25L5121E)
#define MXIC_SNOR_MAX_TIME_ERASE_CHIP       2000U
#elif defined(MX25V512F)
#define MXIC_SNOR_MAX_TIME_ERASE_CHIP       2250U
#elif defined(MX25V5126F)
#define MXIC_SNOR_MAX_TIME_ERASE_CHIP       3200U
#elif defined(MX25R512F)
 ...
 *************************************************************************************************/
#if defined(MX25V512F) || defined(MX25V5126F) || \
    defined(MX25R512F)
 ...
 *************************************************************************************************/
    ...
    !defined(MX25U5121E) && \
    !defined(MX25L5121E)  // Not support
...
#if defined(SUPPORT_OCTAL) || \
    defined(MX25V512C) || \
    defined(MX25L512C) || defined(MX25L5121E)
// Empty define, Not support 112, 122, 114, 144 commands

#elif defined(MX25V512E) || \
      defined(MX25L512E)
...
//#else
#if !defined(MX25V5126F)   // Not support
...
#elif defined(MX25U5121E) || \
      defined(MX25V512C)  || defined(MX25V512E) || \
      defined(MX25L512C)  || defined(MX25L512E) || defined(MX25L5121E)
...
#if defined(MX25R512F)   // Support RDCR command read out CR1 & CR2
