 ...
 * @file    MXIC_SNOR_1M.h
 * @brief   This file contains all information of Macronix 1M bit xSPI memory.
...
#ifndef __MXIC_SNOR_1M_H
#define __MXIC_SNOR_1M_H
 ...
 * 1.8V : MX25U1001E
 * 2.5V : MX25V1006E, MX25V1006F, MX25V1035F
 * 3.3V : MX25L1001E, MX25L1005C, MX25L1006E, MX25L1021E, MX25L1025C
 * Wide Range :
 *        MX25R1035F
 *************************************************************************************************/
#define MX25R1035F
...
#if defined(MX25V1006E) || defined(MX25V1006F) || \
    defined(MX25L1005C) || defined(MX25L1006E) || defined(MX25L1025C)
#define MXIC_SNOR_MEMORY_TYPE_ID            0x20
#elif defined(MX25L1001E) || defined(MX25L1021E)
#define MXIC_SNOR_MEMORY_TYPE_ID            0x22
#elif defined(MX25V1035F)
#define MXIC_SNOR_MEMORY_TYPE_ID            0x23
#elif defined(MX25U1001E)
#define MXIC_SNOR_MEMORY_TYPE_ID            0x25
#elif defined(MX25R1035F)
#define MXIC_SNOR_MEMORY_TYPE_ID            0x28
#endif

#if defined(MX25V1006E) || defined(MX25V1006F) || defined(MX25V1035F) || \
    defined(MX25L1001E) || defined(MX25L1005C) || defined(MX25L1006E) || defined(MX25L1021E) || \
    defined(MX25L1025C) || \
    defined(MX25R1035F)
#define MXIC_SNOR_MEMORY_CAPACITY_ID        0x11
#elif defined(MX25U1001E)
#define MXIC_SNOR_MEMORY_CAPACITY_ID        0x31
#endif
 ...
 *************************************************************************************************/
#define MXIC_SNOR_FLASH_SIZE                ((1024U / 8U) * 1024U)          // 1M bit = 128K Byte
#if defined(MX25U1001E) || \
    defined(MX25L1001E) || defined(MX25L1021E)
...
#if defined(MX25V1006E) || \
    defined(MX25L1005C) || defined(MX25L1006E) || defined(MX25L1025C)
#define MXIC_SNOR_MAX_TIME_ERASE_CHIP       2000U
#elif defined(MX25V1035F)
#define MXIC_SNOR_MAX_TIME_ERASE_CHIP       2250U
#elif defined(MX25U1001E)
#define MXIC_SNOR_MAX_TIME_ERASE_CHIP       2400U
#elif defined(MX25L1021E)
#define MXIC_SNOR_MAX_TIME_ERASE_CHIP       3000U
#elif defined(MX25R1035F)
#define MXIC_SNOR_MAX_TIME_ERASE_CHIP       3750U
#elif defined(MX25V1006F)
#define MXIC_SNOR_MAX_TIME_ERASE_CHIP       6800U
#endif
 ...
 *************************************************************************************************/
#if defined(MX25V1006F) || defined(MX25V1035F) || \
    defined(MX25L1001E) || \
    defined(MX25R1035F)
 ...
 *************************************************************************************************/
    ...
    !defined(MX25U1001E) && \
    !defined(MX25L1001E) && !defined(MX25L1021E)    // Not support
...
#if !defined(MX25V1035F) && \
    !defined(MX25R1035F)   // Not support
...
#elif defined(MX25U1001E) || \
      defined(MX25V1006E) || \
      defined(MX25L1005C) || defined(MX25L1006E) || defined(MX25L1021E) || defined(MX25L1025C)
#define MXIC_SNOR_SR_BP         0x0CU     /*!< Block protected against program and erase operations, 2 bit */

#elif defined(MX25V1006F)
#define MXIC_SNOR_SR_BP         0x2CU     /*!< Block protected against program and erase operations, 3 bit */
...
typedef struct              // Status Register
{
  ...
  uint8_t Reserved : 2;
#elif MXIC_SNOR_SR_BP == 0x2CU
  uint8_t BP : 2;           // Block protected against program and erase operations
  uint8_t Reserved : 1;
  uint8_t BP3 : 1;          //  BP3 Protected Area
...
#if defined(MX25R1035F)   // Support RDCR command read out CR1 & CR2
...
#elif MXIC_SNOR_CR_DC == 0xC0U  // Configuration Register support DC 2 bit
