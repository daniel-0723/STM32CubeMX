 ...
 * @file    MXIC_SNOR_4M.h
 * @brief   This file contains all information of Macronix 4M bit xSPI memory.
...
#ifndef __MXIC_SNOR_4M_H
#define __MXIC_SNOR_4M_H
 ...
 * 1.8V : MX25U4032E, MX25U4033E, MX25U4035,  MX25U4035F
 * 2.5V : MX25V4005C, MX25V4006E, MX25V4035,  MX25V4035F, MX25V40066
 * 3.3V : MX25L4001E, MX25L4005,  MX25L4005A, MX25L4005C, MX25L4006E, MX25L4025A, MX25L4025C
 *        MX25L4026E
 * Wide Range :
 *        MX25R4035F
 *************************************************************************************************/
...
#if defined(MX25V4005C) || defined(MX25V4006E) || defined(MX25V40066) || \
    defined(MX25L4005)  || defined(MX25L4005A) || defined(MX25L4005C) || defined(MX25L4006E) || \
    defined(MX25L4025A) || defined(MX25L4025C) || defined(MX25L4026E)
#define MXIC_SNOR_MEMORY_TYPE_ID            0x20
#elif defined(MX25L4001E)
#define MXIC_SNOR_MEMORY_TYPE_ID            0x22
#elif defined(MX25V4035F)
#define MXIC_SNOR_MEMORY_TYPE_ID            0x23
#elif defined(MX25U4032E) || defined(MX25U4033E) || defined(MX25U4035) || defined(MX25U4035F) || \
      defined(MX25V4035)
#define MXIC_SNOR_MEMORY_TYPE_ID            0x25
#elif defined(MX25R4035F)
#define MXIC_SNOR_MEMORY_TYPE_ID            0x28
#endif

#if defined(MX25V4005C) || defined(MX25V4006E) || defined(MX25V4035F) || defined(MX25V40066) || \
    defined(MX25L4001E) || defined(MX25L4005)  || defined(MX25L4005A) || defined(MX25L4005C) || \
    defined(MX25L4006E) || defined(MX25L4025A) || defined(MX25L4025C) || defined(MX25L4026E) || \
    defined(MX25R4035F)
#define MXIC_SNOR_MEMORY_CAPACITY_ID        0x13
#elif defined(MX25U4032E) || defined(MX25U4033E) || defined(MX25U4035) || defined(MX25U4035F)
#define MXIC_SNOR_MEMORY_CAPACITY_ID        0x33
#elif defined(MX25V4035)
#define MXIC_SNOR_MEMORY_CAPACITY_ID        0x53
#endif
 ...
 *************************************************************************************************/
#define MXIC_SNOR_FLASH_SIZE                (4U * (1024U / 8U) * 1024U)     // 4M bit = 512K Byte
#if defined(MX25L4001E)
#define MXIC_SNOR_PAGE_SIZE                 32U                             // 32 Byte per Page
#else
...
#if defined(MX25V4006E) || \
    defined(MX25L4006E) || defined(MX25L4026E)
#define MXIC_SNOR_MAX_TIME_ERASE_CHIP       4000U
#elif defined(MX25U4032E) || defined(MX25U4033E)
#define MXIC_SNOR_MAX_TIME_ERASE_CHIP       5000U
#elif defined(MX25V4005C) || \
      defined(MX25L4005)  || defined(MX25L4005A) || defined(MX25L4005C) || defined(MX25L4025A) || \
      defined(MX25L4025C)
#define MXIC_SNOR_MAX_TIME_ERASE_CHIP       7500U
#elif defined(MX25V4035F) || \
      defined(MX25U4035F)
#define MXIC_SNOR_MAX_TIME_ERASE_CHIP       9000U
#elif defined(MX25U4035) || \
      defined(MX25V4035)
#define MXIC_SNOR_MAX_TIME_ERASE_CHIP       13000U
#elif defined(MX25V40066)
#define MXIC_SNOR_MAX_TIME_ERASE_CHIP       14000U
#elif defined(MX25R4035F)
 ...
 *************************************************************************************************/
#if defined(MX25U4032E) || defined(MX25U4033E) || defined(MX25U4035) || defined(MX25U4035F) || \
    defined(MX25V4035)  || defined(MX25V4035F) || \
    defined(MX25R4035F)
#define SUPPORT_PERFORMANCE_ENHANCE_READ        // performance enhance indicator
#endif

#if defined(MX25U4035F) || \
    defined(MX25V4035F) || \
    defined(MX25R4035F)
 ...
 *************************************************************************************************/
#if defined(MX25U4035F) || \
    defined(MX25V4035F) || defined(MX25V40066) || \
    defined(MX25L4001E) || \
    defined(MX25R4035F)
 ...
 *************************************************************************************************/
#if !defined(MX25U4035)  && \
    !defined(MX25V4005C) && !defined(MX25V4035) && \
    !defined(MX25L4001E) && !defined(MX25L4005) && !defined(MX25L4005A) && !defined(MX25L4005C) && \
    !defined(MX25L4025A) && !defined(MX25L4025C)  // Not support
 ...
 *************************************************************************************************/
#if defined(MX25U4032E) || defined(MX25U4033E)
...
#if !defined(MX25V4005C) && !defined(MX25V4006E) && !defined(MX25V40066) && \
    !defined(MX25L4001E) && !defined(MX25L4005)  && !defined(MX25L4005A) && !defined(MX25L4005C) && \
    !defined(MX25L4006E) && !defined(MX25L4025A) && !defined(MX25L4025C) && !defined(MX25L4026E)  // Not support
 ...
 *************************************************************************************************/
    ...
    !defined(MX25L4001E)   // Not support
...
#if !defined(MX25L4001E) // Not support
...
#elif defined(MX25V4006E) || defined(MX25V40066) || \
      defined(MX25L4006E) || defined(MX25L4026E)
#define MXIC_SNOR_FAST_READ_112_CMD                     0x3B    // DREAD, 1I 2O Read 3/4 Byte Address; 1-1-2

#elif defined(MX25U4032E) || defined(MX25U4033E) || defined(MX25U4035) || \
      defined(MX25V4035)
...
#if defined(MX25U4032E) || defined(MX25U4033E) || defined(MX25U4035)  || defined(MX25U4035F) || \
    defined(MX25V4035)  || defined(MX25V4035F) || defined(MX25V40066) || \
    defined(MX25R4035F)
...
#if defined(MX25U4032E) || defined(MX25U4033E) || defined(MX25U4035) || \
    defined(MX25V4035)
...
#else
#if !defined(MX25V40066)  // Not support
...
#if !defined(MX25U4035F) && \
    !defined(MX25V4035F) && \
    !defined(MX25R4035F)   // Not support
...
#elif defined(MX25V4005C) || defined(MX25V4006E) || \
      defined(MX25L4005)  || defined(MX25L4005A) || defined(MX25L4005C) || defined(MX25L4006E) || \
      defined(MX25L4025A) || defined(MX25L4025C) || defined(MX25L4026E)
...
#if defined(SUPPORT_OCTAL) || \
    defined(MX25V4005C) || defined(MX25V4006E) || defined(MX25V40066) || \
    defined(MX25L4001E) || defined(MX25L4005)  || defined(MX25L4005A) || defined(MX25L4005C) || \
    defined(MX25L4006E) || defined(MX25L4025A) || defined(MX25L4025C) || defined(MX25L4026E)
...
#if defined(MX25R4035F)   // Support RDCR command read out CR1 & CR2
...
#if defined(MX25U4032E) || defined(MX25U4033E) || defined(MX25U4035F) || \
    defined(MX25V4035F) || \
    defined(MX25R4035F)
