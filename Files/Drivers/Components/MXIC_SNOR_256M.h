 ...
 * @file    MXIC_SNOR_256M.h
 * @brief   This file contains all information of Macronix 256M bit xSPI memory.
...
#ifndef __MXIC_SNOR_256M_H
#define __MXIC_SNOR_256M_H
 ...
 * 1.8V : MX25U25635F, MX25U25643G, MX25U25645G, MX25U25672G, MX25U25691G
 * 3.3V : MX25L25633F, MX25L25635E, MX25L25635F, MX25L25639F, MX25L25645G, MX25L25655E, MX25L25655F
 *        MX25L25659F, MX25L25672F, MX25L25673G, MX25L25735E, MX25L25735F
 * Octal :
 * 1.8V : MX25UM25645G, MX25UW25645GS, MX25UW25645GR, MX25UW25645GQ
 * 3.3V : MX25LM25645G, MX25LW25645GS, MX25LW25645GR, MX25LW25645GQ
 * ARMOR :
 * 1.8V : MX75U25690F
 * 3.3V : MX75L25690F, MX75L25691F
 * RPMC :
 * 1.8V : MX77U25650F
 * 3.3V : MX77L25650F
 *************************************************************************************************/
...
#if defined(MX25L25633F) || defined(MX25L25635E) || defined(MX25L25635F) || defined(MX25L25639F) || \
    defined(MX25L25645G) || defined(MX25L25672F) || defined(MX25L25673G) || defined(MX25L25735E) || \
    defined(MX25L25735F)
#define MXIC_SNOR_MEMORY_TYPE_ID            0x20
#elif defined(MX25U25635F) || defined(MX25U25643G) || defined(MX25U25645G) || defined(MX25U25672G)
#define MXIC_SNOR_MEMORY_TYPE_ID            0x25
#elif defined(MX25L25655E) || defined(MX25L25655F) || defined(MX25L25659F) || \
      defined(MX75L25690F) || defined(MX75L25691F)
#define MXIC_SNOR_MEMORY_TYPE_ID            0x26
#elif defined(MX75U25690F)
#define MXIC_SNOR_MEMORY_TYPE_ID            0x29
#elif defined(MX77U25650F) || defined(MX77L25650F)
#define MXIC_SNOR_MEMORY_TYPE_ID            0x75
#elif defined(MX25UM25645G)
#define MXIC_SNOR_MEMORY_TYPE_ID            0x80
#elif defined(MX25UW25645GS) || defined(MX25UW25645GR) || defined(MX25UW25645GQ)
#define MXIC_SNOR_MEMORY_TYPE_ID            0x81
#elif defined(MX25LM25645G)
#define MXIC_SNOR_MEMORY_TYPE_ID            0x85
#elif defined(MX25LW25645GS) || defined(MX25LW25645GR) || defined(MX25LW25645GQ)
#define MXIC_SNOR_MEMORY_TYPE_ID            0x86
#elif defined(MX25U25691G)
#define MXIC_SNOR_MEMORY_TYPE_ID            0x90
#endif

#if defined(MX25L25633F) || defined(MX25L25635E) || defined(MX25L25635F) || defined(MX25L25639F) || \
    defined(MX25L25645G) || defined(MX25L25655E) || defined(MX25L25655F) || defined(MX25L25659F) || \
    defined(MX25L25672F) || defined(MX25L25673G) || defined(MX25L25735E) || defined(MX25L25735F) || \
    defined(MX75L25690F) || defined(MX75L25691F) || defined(MX77L25650F)
#define MXIC_SNOR_MEMORY_CAPACITY_ID        0x19
#elif defined(MX25U25635F)  || defined(MX25U25643G)   || defined(MX25U25645G)   || defined(MX25U25672G)   || \
      defined(MX25U25691G)  || \
      defined(MX25UM25645G) || defined(MX25UW25645GS) || defined(MX25UW25645GR) || defined(MX25UW25645GQ) || \
      defined(MX25LM25645G) || defined(MX25LW25645GS) || defined(MX25LW25645GR) || defined(MX25LW25645GQ) || \
      defined(MX75U25690F)  || \
      defined(MX77U25650F)
#define MXIC_SNOR_MEMORY_CAPACITY_ID        0x39
#endif
 ...
 *************************************************************************************************/
#define MXIC_SNOR_FLASH_SIZE                ((256U / 8U)* 1024U * 1024U)    // 256M bit = 32M Byte
...
#if defined(MX25U25645G)  || defined(MX25U25691G)   || \
    defined(MX25L25633F)  || defined(MX25L25635F)   || defined(MX25L25639F)  || defined(MX25L25655F) || \
    defined(MX25L25659F)  || defined(MX25L25672F)   || defined(MX25L25735F)  || \
    defined(MX25UM25645G) || defined(MX25UW25645GS) || \
    defined(MX25LM25645G) || defined(MX25LW25645GS)
#define MXIC_SNOR_MAX_TIME_ERASE_CHIP       150000U
#elif defined(MX25UW25645GR) || \
      defined(MX25LW25645GR) || \
      defined(MX77U25650F)   || defined(MX77L25650F)
#define MXIC_SNOR_MAX_TIME_ERASE_CHIP       200000U
#elif defined(MX25L25645G) || defined(MX25L25673G)
#define MXIC_SNOR_MAX_TIME_ERASE_CHIP       210000U
#elif defined(MX25UW25645GQ) || \
      defined(MX25LW25645GQ)
#define MXIC_SNOR_MAX_TIME_ERASE_CHIP       250000U
#elif defined(MX25U25643G) || defined(MX25U25672G)
#define MXIC_SNOR_MAX_TIME_ERASE_CHIP       260000U
#elif defined(MX75U25690F) || defined(MX75L25690F) || defined(MX75L25691F)
#define MXIC_SNOR_MAX_TIME_ERASE_CHIP       300000U
#elif defined(MX25U25635F)
#define MXIC_SNOR_MAX_TIME_ERASE_CHIP       320000U
#elif defined(MX25L25635E) || defined(MX25L25655E) || defined(MX25L25735E)
 ...
 *************************************************************************************************/
#if defined(MX25U25635F) || \
    defined(MX25L25635E) || defined(MX25L25635F) || defined(MX25L25639F) || defined(MX25L25645G) || \
    defined(MX25L25655E) || defined(MX25L25655F) || defined(MX25L25659F) || defined(MX25L25673G) || \
    defined(MX25L25735E) || defined(MX25L25735F)
#define MXIC_SNOR_SECURE_OTP_SIZE           (4U * 1024U / 8U)   // Secured OTP Memory 4K bit = 512 Byte
#elif defined(MX25U25643G)  || defined(MX25U25645G)   || defined(MX25U25672G)   || defined(MX25U25691G)   || \
      defined(MX25L25633F)  || defined(MX25L25672F)   || \
      defined(MX25UM25645G) || defined(MX25UW25645GS) || defined(MX25UW25645GR) || defined(MX25UW25645GQ) || \
      defined(MX25LM25645G) || defined(MX25LW25645GS) || defined(MX25LW25645GR) || defined(MX25LW25645GQ) || \
      defined(MX75U25690F)  || \
      defined(MX75L25690F)  || defined(MX75L25691F)   || \
 ...
 *************************************************************************************************/
#if defined(MX25U25643G)  || defined(MX25U25645G)   || defined(MX25U25672G)   || defined(MX25U25691G)   || \
    defined(MX25L25645G)  || defined(MX25L25673G)   || \
    defined(MX25UM25645G) || defined(MX25UW25645GS) || defined(MX25UW25645GR) || defined(MX25UW25645GQ) || \
    defined(MX25LM25645G) || defined(MX25LW25645GS) || defined(MX25LW25645GR) || defined(MX25LW25645GQ)
 ...
 * RPMC & Octal Flash not support QPI
 *************************************************************************************************/
#if defined(MX25U25635F) || defined(MX25U25643G) || defined(MX25U25645G) || defined(MX25U25672G) || \
    defined(MX25U25691G) || \
    defined(MX25L25633F) || defined(MX25L25635F) || defined(MX25L25639F) || defined(MX25L25645G) || \
    defined(MX25L25655F) || defined(MX25L25659F) || defined(MX25L25672F) || defined(MX25L25673G) || \
    defined(MX25L25735F)
 ...
 * RPMC & Octal Flash not support QPI
 *************************************************************************************************/
#if defined(MX25UM25645G) || defined(MX25UW25645GS) || defined(MX25UW25645GR) || defined(MX25UW25645GQ) || \
    defined(MX25LM25645G) || defined(MX25LW25645GS) || defined(MX25LW25645GR) || defined(MX25LW25645GQ)
...
#define SUPPORT_3BYTE_ADDRESS_COMMAND           // 3 Byte address access command
    ...
    !defined(MX25L25735E) &&  !defined(MX25L25735F)  // Not support
#define SUPPORT_34BYTE_ADDRESS_SWITCH           // 3 Byte address switch to 4 Byte address access command
#endif

#if defined(MX25L25735E) || defined(MX25L25735F)
#define FORCE_USE_4BYTE_ADDRESS                 // Force use 4 Byte address on 3/4 Byte command
#endif

#if !defined(MX25L25635E) && !defined(MX25L25655E) && !defined(MX25L25735E) && \
    !defined(MX25L25735F)  // Not support
...
#if !defined(MX25L25635E)  // Not support
#define SUPPORT_BURST_READ_WRAP_AROUND          // Burst Read Wrap Around
#endif

#if defined(MX25UW25645GS) || defined(MX25UW25645GR) || defined(MX25UW25645GQ) || \
    defined(MX25LW25645GS) || defined(MX25LW25645GR) || defined(MX25LW25645GQ)
 ...
 *************************************************************************************************/
#if defined(MX25U25643G) || defined(MX25U25672G) || \
    defined(MX25L25633F) || defined(MX25L25645G) || defined(MX25L25672F) || defined(MX25L25673G) || \
    defined(MX75U25690F) || \
    defined(MX75L25690F) || defined(MX75L25691F) || \
    defined(MX77U25650F) || \
    defined(MX77L25650F)
...
#if !defined(MX25L25635E) && !defined(MX25L25735E)  // Not support
 ...
 *************************************************************************************************/
#if !defined(MX25L25635E) && !defined(MX25L25655E) && !defined(MX25L25735E)  // Not support
 ...
 *************************************************************************************************/
    ...
    !defined(MX25L25655E)  // Not support
 ...
 *************************************************************************************************/
    ...
    !defined(MX25U25635F)  // Not support
#define SUPPORT_ADVANCED_SECTOR_PROTECTION      // Advance Sector Protection / Individual Sector Protection

#if defined(MX25L25635F) || defined(MX25L25639F) || defined(MX25L25655F) || defined(MX25L25659F) || \
    defined(MX25L25735F)
...
#if defined(MX25U25645G)  || defined(MX25U25691G)   ||  \
    defined(MX25L25635F)  || defined(MX25L25639F)   || defined(MX25L25655F)   || defined(MX25L25659F)   || \
    defined(MX25L25735F)  || \
    defined(MX25UM25645G) || defined(MX25UW25645GS) || defined(MX25UW25645GR) || defined(MX25UW25645GQ) || \
    defined(MX25LM25645G) || defined(MX25LW25645GS) || defined(MX25LW25645GR) || defined(MX25LW25645GQ)
 ...
 *************************************************************************************************/
#if defined(MX25U25635F)  || defined(MX25U25645G)   || defined(MX25U25691G)   ||\
    defined(MX25L25635F)  || defined(MX25L25639F)   || defined(MX25L25655F)   || defined(MX25L25659F)   || \
    defined(MX25UM25645G) || defined(MX25UW25645GS) || defined(MX25UW25645GR) || defined(MX25UW25645GQ) || \
    defined(MX25LM25645G) || defined(MX25LW25645GS) || defined(MX25LW25645GR) || defined(MX25LW25645GQ)
...
#endif                                                          // MX25U25635F support 3 Byte mode only
 ...
 * 0x0B & 0xE7 STR 4-4-4 with 4 dummy clock command
 * Define used command as MXIC_SNOR_FAST_READ_444_4DC_CMD
 */
#ifdef SUPPORT_QPI
...
#define MXIC_SNOR_4BYTE_ADDRESS_FAST_READ_111_CMD       0x0C    // FAST READ4B, Fast Read 4 Byte address; 1-1-1/4-4-4

#if !defined(SUPPORT_OCTAL)  // Not support
#if !defined(MX25L25639F)    // Not support
...
#if defined(MX25U25643G) || defined(MX25U25672G)
#define MXIC_SNOR_4BYTE_ADDRESS_FAST_READ_444_CMD1      0x0C    // FAST READ4B, Fast Read 4 Byte address; 1-1-1/4-4-4
#endif
#endif  // SUPPORT_QPI
...
#ifdef  SUPPORT_3BYTE_ADDRESS_COMMAND
#define MXIC_SNOR_PAGE_PROG_111_CMD                     0x02   // PP, Page Program 3/4 Byte Address; 1-1-1/4-4-4

#if defined(MX25L25635E) || defined(MX25L25655E) || defined(MX25L25735E)
#define MXIC_SNOR_CONTINUOUSLY_PROG_111_CMD             0xAD   // CP, Continuously Program 2 Byte data + 3/4 Byte Address; 1-1-1
#endif
...
#define MXIC_SNOR_READ_ELECTRONIC_ID_CMD                0xAB   // RES, Read Electronic ID; 1-1-1/4-4-4
...
#if !defined(MX25L25635E) && !defined(MX25L25655E)  // Not support
...
#if !defined(MX25LM25645G) && !defined(MX25LW25645GS) && !defined(MX25LW25645GR) && !defined(MX25LW25645GQ)  // Not support
...
#define MXIC_SNOR_SR_QE         0x40U     /*!< QE bit; Quad IO mode enabled if =1 */
    ...
    !defined(MX25U25672G) && !defined(MX25U25691G) && \
    !defined(MX25L25672F) && !defined(MX25L25673G)  // Not support
...
#elif defined(MX25L25645G) || defined(MX25L25673G)
#define MXIC_SNOR_CR_ODS        0x03U     /*!< Output driver strength, 2 bit  */
#else
...
#define MXIC_SNOR_CR_TB         0x08U     /*!< Top/Bottom bit used to configure the block protect area */
    ...
    !defined(MX25U25635F) && \
    !defined(MX25L25633F) && !defined(MX25L25635F) && !defined(MX25L25639F) && !defined(MX25L25655F) && \
    !defined(MX25L25659F) && !defined(MX25L25672F) && !defined(MX25L25735F)  // Not support
...
typedef struct              // Configuration Register
{
  ...
  uint8_t DC : 2;           // Dummy Clock Cycles setting
#else
  uint8_t Reserved3 : 2;
#endif
...
typedef struct
{
#if defined(MX25UM25645G) || defined(MX25LM25645G)
  uint8_t Reserved : 4;     // Reserved
#else
  uint8_t Reserved : 3;     // Reserved
...
#if defined(MX25L25635E) || defined(MX25L25655E)
#define MXIC_SNOR_SCUR_4BYTE            ((uint8_t)0x04)    /*!< 3-Bytes or 4-Bytes addressing */
#elif !defined(MX25L25735E)  // Not support
...
#ifdef MXIC_SNOR_SCUR_4BYTE
  uint8_t Address4Byte : 1; // 3-Bytes or 4-Bytes addressing; 1 = 4-Byte Address Mode (Default = 0)
  uint8_t Reserved1 : 1;    // Reserved
#elif defined(MXIC_SNOR_SCUR_PSB) || defined(MXIC_SNOR_SCUR_ESB)
...
#if defined(MX25L25655F) || defined(MX25L25659F)
