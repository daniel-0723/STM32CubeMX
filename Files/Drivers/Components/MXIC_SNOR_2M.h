 ...
 * @file    MXIC_SNOR_2M.h
 * @brief   This file contains all information of Macronix 2M bit xSPI memory.
...
#ifndef __MXIC_SNOR_2M_H
#define __MXIC_SNOR_2M_H
 ...
 * 1.8V : MX25U2032E, MX25U2033E, MX25U2035F
 * 2.5V : MX25V2006E, MX25V2033F, MX25V2035F, MX25V2039F, MX25V20066
 * 3.3V : MX25L2005C, MX25L2006E, MX25L2025,  MX25L2025C, MX25L2026C, MX25L2026D, MX25L2026E
 *        MX25L2027E
 * Wide Range :
 *        MX25R2035F
 *************************************************************************************************/
...
#if defined(MX25V2006E) || defined(MX25V2033F) || defined(MX25V2039F) || defined(MX25V20066) || \
    defined(MX25L2005C) || defined(MX25L2006E) || defined(MX25L2025)  || defined(MX25L2025C) || \
    defined(MX25L2026C) || defined(MX25L2026D) || defined(MX25L2026E) || defined(MX25L2027E)
#define MXIC_SNOR_MEMORY_TYPE_ID            0x20
#elif defined(MX25V2035F)
#define MXIC_SNOR_MEMORY_TYPE_ID            0x23
#elif defined(MX25U2032E) || defined(MX25U2033E) || defined(MX25U2035F)
#define MXIC_SNOR_MEMORY_TYPE_ID            0x25
#elif defined(MX25R2035F)
#define MXIC_SNOR_MEMORY_TYPE_ID            0x28
#endif

#if defined(MX25V2006E) || defined(MX25V2033F) || defined(MX25V2035F) || defined(MX25V2039F) || \
    defined(MX25V20066) || \
    defined(MX25L2005C) || defined(MX25L2006E) || defined(MX25L2025)  || defined(MX25L2025C) || \
    defined(MX25L2026C) || defined(MX25L2026D) || defined(MX25L2026E) || defined(MX25L2027E) || \
    defined(MX25R2035F)
#define MXIC_SNOR_MEMORY_CAPACITY_ID        0x12
#elif defined(MX25U2032E) || defined(MX25U2033E) || defined(MX25U2035F)
#define MXIC_SNOR_MEMORY_CAPACITY_ID        0x32
#endif
 ...
 *************************************************************************************************/
#define MXIC_SNOR_FLASH_SIZE                (2U * (1024U / 8U) * 1024U)     // 2M bit = 256K Byte
...
#if defined(MX25V2006E)
#define MXIC_SNOR_MAX_TIME_ERASE_CHIP       1500U
#elif defined(MX25U2032E) || defined(MX25U2033E)
#define MXIC_SNOR_MAX_TIME_ERASE_CHIP       2500U
#elif defined(MX25L2005C) || defined(MX25L2006E) || defined(MX25L2025)  || defined(MX25L2025C) || \
    defined(MX25L2026C) || defined(MX25L2026D) || defined(MX25L2026E) || defined(MX25L2027E)
#define MXIC_SNOR_MAX_TIME_ERASE_CHIP       3800U
#elif defined(MX25U2035F) || \
      defined(MX25V2035F)
#define MXIC_SNOR_MAX_TIME_ERASE_CHIP       9000U
#elif defined(MX25V2033F) || defined(MX25V2039F) || defined(MX25V20066)
 ...
 *************************************************************************************************/
#if defined(MX25U2032E) || defined(MX25U2033E) || \
    defined(MX25V2033F) || defined(MX25V2039F)
 ...
 *************************************************************************************************/
#if defined(MX25U2032E) || defined(MX25U2033E) || defined(MX25U2035F) || \
    defined(MX25V2035F) || \
    defined(MX25R2035F)
#define SUPPORT_PERFORMANCE_ENHANCE_READ        // performance enhance indicator
#endif

#if defined(MX25U2035F) || \
    defined(MX25V2035F) || \
    defined(MX25R2035F)
 ...
 *************************************************************************************************/
#if defined(MX25V2039F) || defined(MX25V20066)
#define SUPPORT_FACTORY_MODE                    // Factory Mode
#endif

#if defined(MX25U2035F) || \
    defined(MX25V2033F) || defined(MX25V2035F) || defined(MX25V2039F) || \
    defined(MX25R2035F)
 ...
 *************************************************************************************************/
#if defined(MX25U2035F) || \
    defined(MX25V2033F) || defined(MX25V2035F) || defined(MX25V2039F) || defined(MX25V20066) || \
    defined(MX25R2035F)
 ...
 *************************************************************************************************/
#if !defined(MX25L2005C) && !defined(MX25L2025) &&  !defined(MX25L2025C) && !defined(MX25L2026C) && \
    !defined(MX25L2026D)  // Not support
 ...
 *  Other   : RDSCUR 0x2B
 *
 * SUPPORT_BP4_KEY                              // Block protection 4 Key command
 *  Read    :
 *  Program :
 *  Erase   :
 *  Other   : 1-0-0 KEY1 0xC3, KEY2 0xA5
 *
...
#if defined(MX25L2026C) || defined(MX25L2026D) || defined(MX25L2027E)
#define SUPPORT_BP4_KEY                         // Block protection 4 Key command
#endif
...
#define MXIC_SNOR_FAST_READ_111_CMD                     0x0B    // FAST READ, Fast Read 3/4 Byte Address; 1-1-1/4-4-4
    ...
    defined(MX25L2005C) || defined(MX25L2025) || defined(MX25L2025C) || defined(MX25L2026C)
// Empty define, Not support 112, 122, 114, 144 commands

#elif defined(MX25V2006E) || defined(MX25V20066) || \
      defined(MX25L2006E) || defined(MX25L2026D) || defined(MX25L2026E) || defined(MX25L2027E)
...
//#else
#if !defined(MX25V2033F) && !defined(MX25V2039F) && !defined(MX25V20066)  // Not support
...
#if !defined(MX25U2035F) && \
    !defined(MX25V2035F) && \
    !defined(MX25R2035F)  // Not support
...
#define MXIC_SNOR_BP4_KEY1_CMD                          0xC3   // KEY1, Key command to set BP4; 1-0-0
#define MXIC_SNOR_BP4_KEY2_CMD                          0xA5   // KEY2, Key command to set BP4; 1-0-0
...
#define MXIC_SNOR_SR_WEL        0x02U     /*!< Write enable latch */
    ...
    defined(MX25L2005C) || defined(MX25L2006E) || defined(MX25L2025) || defined(MX25L2025C) || \
    defined(MX25L2026E)
#define MXIC_SNOR_SR_BP         0x0CU     /*!< Block protected against program and erase operations, 2 bit */
...
#if defined(MX25V2006E) || defined(MX25V20066) || \
    defined(MX25L2005C) || defined(MX25L2006E) || defined(MX25L2025) || defined(MX25L2025C) || \
    defined(MX25L2026E)
// Empty, Status Register not support BP4/CPM/QE

#elif defined(SUPPORT_BP4_KEY) || \
      defined(MX25V2039F)
#define MXIC_SNOR_SR_BP4        0x40U     /*!< BP4 Protected Area */
...
#define MXIC_SNOR_SR_QE         0x40U     /*!< QE bit; Quad IO mode enabled if =1 */
    ...
    !defined(MX25V2039F) // Not support
...
#if MXIC_SNOR_SR_BP == 0x0CU
  uint8_t BP : 2;           // Block protected against program and erase operations
  uint8_t Reserved : 2;
#elif MXIC_SNOR_SR_BP == 0x1CU
...
#if defined(MXIC_SNOR_SR_BP4)
  uint8_t BP4 : 1;          // BP4 Protected Area
...
#if defined(MX25R2035F)   // Support RDCR command read out CR1 & CR2
...
#if defined(MXIC_SNOR_READ_READ_LOCK_CONFIGURATION_CMD)
...
#if defined(MXIC_SNOR_READ_PERMANENT_LOCK_BIT_LOCK_DOWN_CMD)
