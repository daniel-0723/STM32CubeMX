 ...
 * @file    MXIC_SNOR_8M.h
 * @brief   This file contains all information of Macronix 8M bit xSPI memory.
...
#ifndef __MXIC_SNOR_8M_H
#define __MXIC_SNOR_8M_H
 ...
 * 1.8V : MX25U8031E, MX25U8032E, MX25U8033E, MX25U8035,  MX25U8035E, MX25U8035F
 * 2.5V : MX25V8005,  MX25V8006E, MX25V8033F, MX25V8035,  MX25V8035F
 * 3.3V : MX25L8001F, MX25L8005,  MX25L8006E, MX25L8008E, MX25L8025,  MX25L8035E, MX25L8036E
...
#if defined(MX25V8005)  || defined(MX25V8006E) || \
    defined(MX25L8005)  || defined(MX25L8006E) || defined(MX25L8008E) || defined(MX25L8025) || \
    defined(MX25L8035E) || defined(MX25L8036E) || defined(MX25L8073E) || defined(MX25L8075E)
#define MXIC_SNOR_MEMORY_TYPE_ID            0x20
#elif defined(MX25L8001F)
#define MXIC_SNOR_MEMORY_TYPE_ID            0x22
#elif defined(MX25V8033F) || defined(MX25V8035F)
#define MXIC_SNOR_MEMORY_TYPE_ID            0x23
#elif defined(MX25U8031E) || defined(MX25U8032E) || defined(MX25U8033E) || defined(MX25U8035) || \
      defined(MX25U8035E) || defined(MX25U8035F) || \
      defined(MX25V8035)
#define MXIC_SNOR_MEMORY_TYPE_ID            0x25
#elif defined(MX25R8035F)
#define MXIC_SNOR_MEMORY_TYPE_ID            0x28
#endif

#if defined(MX25V8005)  || defined(MX25V8006E) || defined(MX25V8033F) || defined(MX25V8035F) || \
    defined(MX25L8001F) || defined(MX25L8005)  || defined(MX25L8006E) || defined(MX25L8008E) || \
    defined(MX25L8025)  || defined(MX25L8035E) || defined(MX25L8036E) || defined(MX25L8073E) || \
    defined(MX25L8075E) || \
    defined(MX25R8035F)
#define MXIC_SNOR_MEMORY_CAPACITY_ID        0x14
#elif defined(MX25U8031E) || defined(MX25U8032E) || defined(MX25U8033E) || defined(MX25U8035) || \
      defined(MX25U8035E) || defined(MX25U8035F)
#define MXIC_SNOR_MEMORY_CAPACITY_ID        0x34
#elif defined(MX25V8035)
#define MXIC_SNOR_MEMORY_CAPACITY_ID        0x54
#endif
 ...
 *************************************************************************************************/
#define MXIC_SNOR_FLASH_SIZE                ((8U / 8U) * 1024U * 1024U)     // 8M bit = 1M Byte

#if defined(MX25L8001F)
#define MXIC_SNOR_PAGE_SIZE                 512U                            // 512 Byte per Page
#else
...
#if defined(MX25U8031E) || defined(MX25U8032E) || \
    defined(MX25V8006E) || \
    defined(MX25L8006E) || defined(MX25L8008E)
#define MXIC_SNOR_MAX_TIME_ERASE_CHIP       6000U
#elif defined(MX25U8033E) || defined(MX25U8035E)
#define MXIC_SNOR_MAX_TIME_ERASE_CHIP       10000U
#elif defined(MX25V8005)  || \
      defined(MX25L8005)  || defined(MX25L8025) || defined(MX25L8035E) || defined(MX25L8036E) || \
      defined(MX25L8073E) || defined(MX25L8075E)
#define MXIC_SNOR_MAX_TIME_ERASE_CHIP       15000U
#elif defined(MX25V8033F) || defined(MX25V8035F) || \
      defined(MX25U8035F)
#define MXIC_SNOR_MAX_TIME_ERASE_CHIP       18000U
#elif defined(MX25V8035)
#define MXIC_SNOR_MAX_TIME_ERASE_CHIP       22000U
#elif defined(MX25U8035)
 ...
 *************************************************************************************************/
#if defined(MX25U8035)  || \
    defined(MX25V8006E) || defined(MX25V8035) || \
    defined(MX25L8006E) || defined(MX25L8008E)
#define MXIC_SNOR_SECURE_OTP_SIZE           (512U / 8U)         // Secured OTP Memory 512 bit = 64 Byte
#elif defined(MX25U8031E) || defined(MX25U8032E) || defined(MX25U8033E) || defined(MX25U8035E) || \
      defined(MX25L8035E) || defined(MX25L8036E) || defined(MX25L8073E) || defined(MX25L8075E)
#define MXIC_SNOR_SECURE_OTP_SIZE           (4U * 1024U / 8U)   // Secured OTP Memory 4K bit = 512 Byte
#elif defined(MX25U8035F) || \
      defined(MX25V8033F) || defined(MX25V8035F) || \
      defined(MX25R8035F)
 ...
 *************************************************************************************************/
    ...
    !defined(MX25V8005)  && !defined(MX25V8006E) && \
    !defined(MX25L8001F) && !defined(MX25L8005)  && !defined(MX25L8006E) && !defined(MX25L8008E) && \
    !defined(MX25L8025)  // Not support
#define SUPPORT_PERFORMANCE_ENHANCE_READ        // performance enhance indicator
#endif

#if defined(MX25U8035E) || defined(MX25U8035F) || \
    defined(MX25V8033F) || defined(MX25V8035F) || \
    defined(MX25R8035F)
 ...
 *************************************************************************************************/
#if !defined(MX25U8031E) && !defined(MX25U8032E) && !defined(MX25U8033E) && !defined(MX25U8035) && \
    !defined(MX25V8005)  && !defined(MX25V8006E) && !defined(MX25V8035)  && \
    !defined(MX25L8005)  && !defined(MX25L8006E) && !defined(MX25L8008E) && !defined(MX25L8025) && \
    !defined(MX25L8035E) && !defined(MX25L8036E) && !defined(MX25L8073E) && !defined(MX25L8075E)  // Not support
 ...
 *************************************************************************************************/
#if !defined(MX25U8035)  && \
    !defined(MX25V8005)  && !defined(MX25V8035) && \
    !defined(MX25L8001F) && !defined(MX25L8005) && !defined(MX25L8025) && !defined(MX25L8035E) && \
    !defined(MX25L8036E)  // Not support
 ...
 *************************************************************************************************/
#if defined(MX25U8031E) || defined(MX25U8032E) || defined(MX25U8033E) || defined(MX25U8035E)
...
#if !defined(MX25V8005)  && \
    !defined(MX25L8001F) && !defined(MX25L8005) && !defined(MX25L8025)  // Not support
 ...
 *************************************************************************************************/
#if !defined(SUPPORT_OCTAL) && \
    !defined(MX25L8001F)  // Not support
...
#if defined(MX25U8031E) || defined(MX25U8032E) || defined(MX25U8033E) || defined(MX25U8035) || \
    defined(MX25U8035E) || defined(MX25U8035F) || \
    defined(MX25V8033F) || defined(MX25V8035)  || defined(MX25V8035F) || \
    defined(MX25R8035F)
...
#if !defined(MX25U8035F) && \
    !defined(MX25V8033F) && !defined(MX25V8035F) && \
    !defined(MX25R8035F)   // Not support
...
#if defined(MX25L8001F)
// Empty, Status Register not support BP

#elif defined(MX25V8005) || defined(MX25V8006E) || \
      defined(MX25L8005) || defined(MX25L8006E) || defined(MX25L8008E) || defined(MX25L8025)
...
#if defined(MX25R8035F)     // Support RDCR command read out CR1 & CR2
...
#if !defined(MX25L8008E)  // Not support
