 ...
 * @file    MXIC_SNOR_64M.h
 * @brief   This file contains all information of Macronix 64M bit xSPI memory.
...
#ifndef __MXIC_SNOR_64M_H
#define __MXIC_SNOR_64M_H
 ...
 * 1.2V : MX25S6433F, MX25S6435F, MX25S6473F
 * 1.8V : MX25U6429F, MX25U6432F, MX25U6433F, MX25U6435E, MX25U6435F, MX25U6472F, MX25U6473F
 *        MX25U64356
 * 3.3V : MX25L6405D, MX25L6406E, MX25L6408D, MX25L6408E, MX25L6433F, MX25L6435E, MX25L6436E
 *        MX25L6436F, MX25L6439E, MX25L6445E, MX25L6450F, MX25L6455E, MX25L6455F, MX25L6456E
 *        MX25L6456F, MX25L6465E, MX25L6473E, MX25L6473F, MX25L6475E, MX25L6495F, MX25L64356
 *        MX25L64736
 * Wide Range :
 *        MX25R6435F
 * Octal :
 * 1.8V : MX25UW6345GS, MX25UW6345GR, MX25UW6345GQ, MX25UW6445GS, MX25UW6445GR, MX25UW6445GQ
 * RPMC :
 * 3.3V : MX77L6450F
 * Security :
 * 1.8V : MX78U64A00F
...
#if defined(MX25L6405D) || defined(MX25L6406E) || defined(MX25L6408D) || defined(MX25L6408E) || \
    defined(MX25L6433F) || defined(MX25L6435E) || defined(MX25L6436E) || defined(MX25L6436F) || \
    defined(MX25L6445E) || defined(MX25L6450F) || defined(MX25L6465E) || defined(MX25L6473E) || \
    defined(MX25L6473F) || defined(MX25L6475E) || defined(MX25L64356) || defined(MX25L64736)
#define MXIC_SNOR_MEMORY_TYPE_ID            0x20
#elif defined(MX25U6429F) || defined(MX25U6432F) || defined(MX25U6433F) || defined(MX25U6435E) || \
      defined(MX25U6435F) || defined(MX25U6472F) || defined(MX25U6473F) || defined(MX25U64356) || \
      defined(MX25L6439E)
#define MXIC_SNOR_MEMORY_TYPE_ID            0x25
#elif defined(MX25L6455E) || defined(MX25L6455F) || defined(MX25L6456E) || defined(MX25L6456F)
#define MXIC_SNOR_MEMORY_TYPE_ID            0x26
#elif defined(MX25R6435F)
#define MXIC_SNOR_MEMORY_TYPE_ID            0x28
#elif defined(MX78U64A00F)
#define MXIC_SNOR_MEMORY_TYPE_ID            0x29
#elif defined(MX25S6433F) || defined(MX25S6435F) || defined(MX25S6473F)
#define MXIC_SNOR_MEMORY_TYPE_ID            0x2B
#elif defined(MX77L6450F)
#define MXIC_SNOR_MEMORY_TYPE_ID            0x75
#elif defined(MX25UW6445GS) || defined(MX25UW6445GR) || defined(MX25UW6445GQ)
#define MXIC_SNOR_MEMORY_TYPE_ID            0x81
#elif defined(MX25UW6345GS) || defined(MX25UW6345GR) || defined(MX25UW6345GQ)
#define MXIC_SNOR_MEMORY_TYPE_ID            0x84
#elif defined(MX25L6495F)
#define MXIC_SNOR_MEMORY_TYPE_ID            0x95
#endif

#if defined(MX25L6405D) || defined(MX25L6406E) || defined(MX25L6408D) || defined(MX25L6408E) || \
    defined(MX25L6433F) || defined(MX25L6435E) || defined(MX25L6436E) || defined(MX25L6436F) || \
    defined(MX25L6445E) || defined(MX25L6450F) || defined(MX25L6455E) || defined(MX25L6455F) || \
    defined(MX25L6456E) || defined(MX25L6456F) || defined(MX25L6465E) || defined(MX25L6473E) || \
    defined(MX25L6473F) || defined(MX25L6475E) || defined(MX25L6495F) || defined(MX25L64356) || \
    defined(MX25L64736) || \
    defined(MX25R6435F) || \
    defined(MX77L6450F) || \
    defined(MX78U64A00F)
#define MXIC_SNOR_MEMORY_CAPACITY_ID        0x17
#elif defined(MX25S6435F)
#define MXIC_SNOR_MEMORY_CAPACITY_ID        0x26
#elif defined(MX25S6433F) || defined(MX25S6473F)
#define MXIC_SNOR_MEMORY_CAPACITY_ID        0x27
#elif defined(MX25U6429F)   || defined(MX25U6432F)   || defined(MX25U6433F)   || defined(MX25U6435E)   || \
      defined(MX25U6435F)   || defined(MX25U6472F)   || defined(MX25U6473F)   || defined(MX25U64356)   || \
      defined(MX25L6439E)   || \
      defined(MX25UW6345GS) || defined(MX25UW6345GR) || defined(MX25UW6345GQ) || defined(MX25UW6445GS) || \
      defined(MX25UW6445GR) || defined(MX25UW6445GQ)
#define MXIC_SNOR_MEMORY_CAPACITY_ID        0x37
#endif
 ...
 *************************************************************************************************/
#define MXIC_SNOR_FLASH_SIZE                ((64U / 8U) * 1024U * 1024U)    // 64M bit = 8M Byte
...
#if defined(MX25UW6345GS) || defined(MX25UW6445GS)
#define MXIC_SNOR_MAX_TIME_ERASE_CHIP       38000U
#elif defined(MX25U6429F)
#define MXIC_SNOR_MAX_TIME_ERASE_CHIP       40000U
#elif defined(MX25U6432F)   || defined(MX25U6472F) || defined(MX25U64356) || \
      defined(MX25UW6345GR) || defined(MX25UW6445GR)
#define MXIC_SNOR_MAX_TIME_ERASE_CHIP       50000U
#elif defined(MX25L6433F) || defined(MX25L6436F) || defined(MX25L6455F) || defined(MX25L6456F) || \
      defined(MX25L6473F) || defined(MX25L6495F) || defined(MX25L64356) || defined(MX25L64736)
#define MXIC_SNOR_MAX_TIME_ERASE_CHIP       60000U
#elif defined(MX25UW6345GQ) || defined(MX25UW6445GQ)
#define MXIC_SNOR_MAX_TIME_ERASE_CHIP       63000U
#elif defined(MX25U6435F)  || defined(MX25U6473F) || \
      defined(MX78U64A00F)
#define MXIC_SNOR_MAX_TIME_ERASE_CHIP       75000U
#elif defined(MX25L6450F) || \
      defined(MX77L6450F)
#define MXIC_SNOR_MAX_TIME_ERASE_CHIP       76000U
#elif defined(MX25U6435E) || \
      defined(MX25L6405D) || defined(MX25L6406E) || defined(MX25L6408D) || defined(MX25L6408E) || \
      defined(MX25L6435E) || defined(MX25L6436E) || defined(MX25L6439E) || defined(MX25L6445E) || \
      defined(MX25L6455E) || defined(MX25L6456E) || defined(MX25L6465E) || defined(MX25L6473E) || \
      defined(MX25L6475E)
...
#elif defined(MX25R6435F)
#define MXIC_SNOR_MAX_TIME_ERASE_CHIP       240000U
#elif defined(MX25S6435F)
#define MXIC_SNOR_MAX_TIME_ERASE_CHIP       2025000U
#endif
...
#elif defined(MX25U6435E) || defined(MX25U6435F) || defined(MX25U6473F) || \
      defined(MX25L6435E) || defined(MX25L6436E) || defined(MX25L6439E) || defined(MX25L6445E) || \
      defined(MX25L6450F) || defined(MX25L6455E) || defined(MX25L6456E) || defined(MX25L6465E) || \
      defined(MX25L6473E) || defined(MX25L6475E) || \
      defined(MX77L6450F)
#define MXIC_SNOR_SECURE_OTP_SIZE           (4U * 1024U / 8U)   // Secured OTP Memory 4K bit = 512 Byte
#elif defined(MX25S6433F)   || defined(MX25S6435F)   || defined(MX25S6473F)   || \
      defined(MX25U6429F)   || defined(MX25U6432F)   || defined(MX25U6433F)   || defined(MX25U6472F)   || \
      defined(MX25U64356)   || \
      defined(MX25L6433F)   || defined(MX25L6436F)   || defined(MX25L6455F)   || defined(MX25L6456F)   || \
      defined(MX25L6473F)   || defined(MX25L6495F)   || defined(MX25L64356)   || defined(MX25L64736)   || \
      defined(MX25R6435F)   || \
      defined(MX25UW6345GS) || defined(MX25UW6345GR) || defined(MX25UW6345GQ) || defined(MX25UW6445GS) || \
      defined(MX25UW6445GR) || defined(MX25UW6445GQ) || \
 ...
 *************************************************************************************************/
#if defined(MX25L6445E)   || defined(MX25L6455E)   || defined(MX25L6465E)   || \
    defined(MX25UW6345GS) || defined(MX25UW6345GR) || defined(MX25UW6345GQ) || defined(MX25UW6445GS) || \
    defined(MX25UW6445GR) || defined(MX25UW6445GQ) || \
    defined(MX78U64A00F)
 ...
 * RPMC & Octal Flash not support QPI
 *************************************************************************************************/
#if defined(MX25U6429F) || defined(MX25U6432F) || defined(MX25U6435E) || defined(MX25U6435F) || \
    defined(MX25U6472F) || defined(MX25U6473F) || defined(MX25U64356) || \
    defined(MX25L6439E) || defined(MX25L64356) || defined(MX25L64736) || \
    defined(MX78U64A00F)
 ...
 * RPMC & Octal Flash not support QPI
 *************************************************************************************************/
#if defined(MX25UW6345GS) || defined(MX25UW6345GR) || defined(MX25UW6345GQ) || defined(MX25UW6445GS) || \
    defined(MX25UW6445GR) || defined(MX25UW6445GQ)
 ...
 *************************************************************************************************/
    ...
    !defined(MX25L6405D) && !defined(MX25L6406E) && !defined(MX25L6408D) && !defined(MX25L6408E) && \
    !defined(MX25L6436E)  // Not support
#define SUPPORT_PERFORMANCE_ENHANCE_READ        // performance enhance indicator
#endif

#if !defined(MX25L6405D) && !defined(MX25L6406E) && !defined(MX25L6408D) && !defined(MX25L6408E) && \
    !defined(MX25L6435E) && !defined(MX25L6436E) && !defined(MX25L6445E) && !defined(MX25L6450F) && \
    !defined(MX25L6455E) && !defined(MX25L6456E) && !defined(MX25L6465E) && !defined(MX25L6473E) && \
    !defined(MX25L6475E) && \
    !defined(MX77L6450F)  // Not support
 ...
 *************************************************************************************************/
#if defined(MX25U6429F) || defined(MX25U6432F) || defined(MX25U6472F) || defined(MX25U64356) || \
    defined(MX25L64356) || defined(MX25L64736)
#define SUPPORT_FACTORY_MODE                    // Factory Mode
#endif

#if !defined(MX25L6405D) && !defined(MX25L6406E) && !defined(MX25L6408D) && !defined(MX25L6408E) && \
    !defined(MX25L6435E) && !defined(MX25L6436E) && !defined(MX25L6445E) && !defined(MX25L6455E) && \
    !defined(MX25L6456E) && !defined(MX25L6465E) && !defined(MX25L6473E) && !defined(MX25L6475E)   // Not support
#define SUPPORT_PROGRAM_ERASE_SUSPEND           // Program/Erase Suspend
#endif

#if defined(MX25L6405D) || defined(MX25L6408D) || defined(MX25L6435E) || defined(MX25L6436E) || \
    defined(MX25L6445E) || defined(MX25L6455E) || defined(MX25L6456E) || defined(MX25L6465E) || \
    defined(MX25L6473E) || defined(MX25L6475E)
 ...
 *************************************************************************************************/
#if defined(MX78U64A00F)
#define SUPPORT_SECURITY_FIELD_COMMAND          // Security Flash
#endif

#if defined(MX77L6450F)
 ...
 *************************************************************************************************/
#if !defined(MX25L6405D) && !defined(MX25L6406E) && !defined(MX25L6408D) && !defined(MX25L6408E) && \
    !defined(MX25L6436E) && !defined(MX25L6445E) && !defined(MX25L6455E) && !defined(MX25L6465E)  // Not support
 ...
 *************************************************************************************************/
#if !defined(MX25S6435F) && \
    !defined(MX25L6405D) && !defined(MX25L6408D) && !defined(MX25L6408E) && !defined(MX25L6445E) && \
    !defined(MX78U64A00F) // Not support
...
#if defined(MX25U6429F) || defined(MX25U6432F) || defined(MX25U6435E) || defined(MX25U6435F) || \
    defined(MX25U6472F) || defined(MX25U6473F) || defined(MX25U64356) || \
    defined(MX25L6435E) || defined(MX25L6439E) || defined(MX25L6456E) || defined(MX25L6473E) || \
    defined(MX25L6475E)
 ...
 * MXIC_SNOR_FREAD_444 mode will use 1 command only that come from 0xEA, 0xEB, 0x0B.
...
#if defined(MX25L64356) || defined(MX25L64736)
#define MXIC_SNOR_FAST_READ_444_CMD2                    0x0B    // FAST READ, Fast Read 3/4 Byte Address; 1-1-1/4-4-4 + Enhance
#endif

#if defined(MX25U6435E) || defined(MX25U6435F) || defined(MX25U6473F) || \
    defined(MX25L6439E)
...
#if !defined(SUPPORT_OCTAL) && \
    !defined(MX25L6405D) && !defined(MX25L6406E) && !defined(MX25L6408D) && !defined(MX25L6408E)  // Not support
...
#if !defined(SUPPORT_OCTAL) && \
    !defined(MX25L6405D) && !defined(MX25L6406E) && !defined(MX25L6408D) && !defined(MX25L6408E)   // Not support 32K erase command
...
#if !defined(MX25L6439E)  //　Not support
...
#if defined(MX25L6435E) || defined(MX25L6436E) || defined(MX25L6445E) || defined(MX25L6455E) || \
    defined(MX25L6456E) || defined(MX25L6465E) || defined(MX25L6473E) || defined(MX25L6475E)
...
#if defined(MX25L6436E) || defined(MX25L6445E) || defined(MX25L6455E) || defined(MX25L6465E)
...
#if !defined(MX25L6455F) && !defined(MX25L6456F)  // Not support
...
#else   // Mutually exclusive with command 0x36, 0x39, 0x3C
#if !defined(MX25L6455F) && !defined(MX25L6456F)  // Not support
...
#if !defined(MX25L6436F) && !defined(MX25L6455F) // Not support
...
#endif
#endif  // Mutually exclusive with command 0x36, 0x39, 0x3C
...
#define MXIC_SNOR_READ_READ_LOCK_CONFIGURATION_CMD      0xD5   // RRLCR, Read Read-Lock Area Configuration Register; 1-0-1
#define MXIC_SNOR_WRITE_READ_LOCK_CONFIGURATION_CMD     0xDD   // WRLCR, Write Read-Lock Area Configuration Register; 1-0-1
#define MXIC_SNOR_READ_READ_LOCK_CONFIGURATION_CMD1     0x26   // RRLCR, Read Read-Lock Area Configuration Register; 1-0-1
#define MXIC_SNOR_WRITE_READ_LOCK_CONFIGURATION_CMD1    0x28   // WRLCR, Write Read-Lock Area Configuration Register; 1-0-1
...
//#define MXIC_SNOR_WRITE_READ_LOCK_BIT_CMD               0x21   // WRLB, Write Read-Lock bit 2; 1-0-1
...
#if !defined(MX25S6433F) && !defined(MX25S6435F) && !defined(MX25S6473F) && \
    !defined(MX25U6429F) && !defined(MX25U6432F) && !defined(MX25U6433F) && !defined(MX25U6472F) && \
    !defined(MX25R6435F)  // Not support
...
#if defined(MX25U6432F) || defined(MX25U6472F) || defined(MX25U64356) || \
    defined(MX25L64356) || defined(MX25L64736)
...
#if !defined(MX78U64A00F)  // Not support
#define MXIC_SNOR_SR_BP         0x3CU     /*!< Block protected against program and erase operations */
#endif

#if defined(SUPPORT_OCTAL) || \
    defined(MX25L6406E) || defined(MX25L6408E)
// Empty, Not used
#elif defined(MX25L6405D) || defined(MX25L6408D)
#define MXIC_SNOR_SR_CPM        0x40U     /*!< Continuous Program mode */
...
#define MXIC_SNOR_SR_QE         0x40U     /*!< QE bit; Quad IO mode enabled if =1 */
    ...
    !defined(MX25S6473F) && \
    !defined(MX25U6472F) && !defined(MX25U6473F) && \
    !defined(MX25L6473E) && !defined(MX25L6473F) && !defined(MX25L64736) && \
    !defined(MX78U64A00F)  // Not support
...
#ifdef MXIC_SNOR_SR_BP
  uint8_t BP : 4;           // Block protected against program and erase operations
#else
  uint8_t Reserved : 4;
#endif

#ifdef MXIC_SNOR_SR_CPM
  uint8_t CPM : 1;          // Continuous Program mode
#elif defined(MXIC_SNOR_SR_QE)
...
#if defined(MX25S6435F) || \
    defined(MX25U6433F) || \
    defined(MX25L6435E) || defined(MX25L6439E) || defined(MX25L6450F) || defined(MX25L6456E) || \
    defined(MX25L6473E) || defined(MX25L6475E) || \
    defined(MX25R6435F) || \
    defined(MX77L6450F)
...
#elif defined(MX25L6433F) || defined(MX25L6436F) || defined(MX25L6455F) || defined(MX25L6456F) || \
      defined(MX25L6473F) || defined(MX25L6495F)
#define MXIC_SNOR_CR_ODS        0x01U     /*!< Output driver strength, 1 bit */

#else
#define MXIC_SNOR_CR_ODS        0x07U     /*!< Output driver strength, 3 bit */
#endif
...
#define MXIC_SNOR_CR_PBE        0x10U     /*!< Preamble Bit Enable */
    ...
    defined(MX25L6450F) || \
    defined(MX77L6450F)
// Empty, Configuration Register not support DC, Dummy Clock

#elif defined(MX25S6435F) || \
      defined(MX25L6433F) || defined(MX25L6436F) || defined(MX25L6455F) || defined(MX25L6456F) || \
      defined(MX25L6473F) || defined(MX25L6495F) || defined(MX25L64356) || defined(MX25L64736) || \
      defined(MX25R6435F)
#define MXIC_SNOR_CR_DC         0x40U     /*!< Dummy Clock Cycles setting, 1 bit @ bit 6 */

#elif defined(MX25L6435E) || defined(MX25L6439E) || defined(MX25L6456E) || defined(MX25L6473E) || \
      defined(MX25L6475E)
#define MXIC_SNOR_CR_DC         0x80U     /*!< Dummy Clock Cycles setting, 1 bit @ bi t 7 */
...
{
#if MXIC_SNOR_CR_ODS == 0x01U
  uint8_t ODS : 1;          // Output driver strength, 1 bit
  uint8_t Reserved : 2;
#elif MXIC_SNOR_CR_ODS == 0x07U
  uint8_t ODS : 3;          // Output driver strength, 3 bit
#else
  uint8_t Reserved : 3;
#endif

#ifdef MXIC_SNOR_CR_TB
...
#if MXIC_SNOR_CR_DC == 0x40U
  uint8_t DC : 1;           // Dummy Clock Cycles setting, 1 bit @ bit 6
  uint8_t Reserved4 : 1;
#elif MXIC_SNOR_CR_DC == 0x80U
  uint8_t Reserved4 : 1;
...
#if defined(MX25S6433F) || defined(MX25S6473F) || \
    defined(MX25R6435F)          // RDCR command read out CR1 & CR2 data
...
#if MXIC_SNOR_CR_DC == 0x40U    // Configuration Register DC 1 bit
...
#define MXIC_SNOR_DUMMY_CLOCK_444        6    // 0xEB, 0x0B
#elif DC_INDEX == 1
#define MXIC_SNOR_DUMMY_CLOCK_111        8    // 0x0B
#define MXIC_SNOR_DUMMY_CLOCK_112        8    // 0x3B
#define MXIC_SNOR_DUMMY_CLOCK_114        8    // 0x6B
#define MXIC_SNOR_DUMMY_CLOCK_122        8    // 0xBB
#define MXIC_SNOR_DUMMY_CLOCK_144        10   // 0xEB
#define MXIC_SNOR_DUMMY_CLOCK_444        10   // 0xEB, 0x0B
#endif

#elif MXIC_SNOR_CR_DC == 0x80U  // Configuration Register DC 1 bit
...
#define MXIC_SNOR_DUMMY_CLOCK_444        8    // 0xEB, 0x0B
#endif
...
#define MXIC_SNOR_DUMMY_CLOCK_122        4    // 0xBB, 0xBC
#define MXIC_SNOR_DUMMY_CLOCK_144        12   // 0xEB, 0xEC
#define MXIC_SNOR_DUMMY_CLOCK_444        12   // 0xEB, 0xEC
#else
#define MXIC_SNOR_DUMMY_CLOCK_111        8    // 0x0B, 0x0C
#define MXIC_SNOR_DUMMY_CLOCK_112        8    // 0x3B, 0x3C
#define MXIC_SNOR_DUMMY_CLOCK_114        8    // 0x6B, 0x6C
...
#define MXIC_SNOR_DUMMY_CLOCK_122        4    // 0xBB, 0xBC
#define MXIC_SNOR_DUMMY_CLOCK_144        6    // 0xEB, 0xEC
#define MXIC_SNOR_DUMMY_CLOCK_444        6    // 0xEB, 0xEC, 0x0B
...
#if !defined(MX25L6408D) && !defined(MX25L6408E)
...
#if defined(MX78U64A00F)
#define MXIC_SNOR_SCUR_OutRDY           ((uint8_t)0x10)    /*!< Packet Out Ready bit */

#elif defined(MXIC_SNOR_ENTER_SECURITY_FIELD_CMD)
#define MXIC_SNOR_SCUR_ENSF             ((uint8_t)0x10)    /*!< Security Field bit */

#elif defined(MXIC_SNOR_CONTINUOUSLY_PROG_111_CMD) && !defined(MXIC_SNOR_SR_CPM)
#define MXIC_SNOR_SCUR_CPM              ((uint8_t)0x10)    /*!< Continuously Program mode */
#endif

#if !defined(MX25L6405D) && !defined(MX25L6406E) && !defined(MX25L6408D) && !defined(MX25L6408E)  // Not support
...
#if defined(MX78U64A00F)
#define MXIC_SNOR_SCUR_Error            ((uint8_t)0x80)    /*!< Secutity command error status */
#elif defined(MXIC_SNOR_WRITE_PROTECT_SELECTION_CMD)
#define MXIC_SNOR_SCUR_WPSEL            ((uint8_t)0x80)    /*!< Write Protection Selection */
#endif

typedef struct              // Security Register
{
#ifdef MXIC_SNOR_SCUR_OTP_INDICATOR
  uint8_t SecuredOTP : 1;   // Secured OTP indicator bit; 1 = Factory Lock
#else
  uint8_t Reserved : 1;     // Reserved
#endif

#ifdef MXIC_SNOR_SCUR_LDSO
...
#ifdef MXIC_SNOR_SCUR_OutRDY
  uint8_t OutRDY : 1;       // Packet Out Ready bit; 1 = Ready
#elif defined(MXIC_SNOR_SCUR_ENSF)
...
#ifdef MXIC_SNOR_SCUR_Error
  uint8_t Error : 1;        // Secutity command error status (Default = 0)
          // 0 = No error in most recent security command
          // 1 = Indicate error occurred in most recent security command
#elif defined(MXIC_SNOR_SCUR_WPSEL)
...
// Lock Register **********************************************************************************
#if defined(MX25UW6345GS) || defined(MX25UW6345GR) || defined(MX25UW6345GQ) || defined(MX25UW6445GS) || \
    defined(MX25UW6445GR) || defined(MX25UW6445GQ)  // 8 bit Register
...
#if defined(MX25L6456F)
#define MXIC_SNOR_LR_SPBOTP             ((uint16_t)0x0008) /*!< SPB Lock bit (OTP) */
#endif
...
#if defined(MX25U6429F) || defined(MX25U6432F) || defined(MX25U6472F) || defined(MX25U64356) || \
    defined(MX25L6456F) || defined(MX25L64356) || defined(MX25L64736)
...
typedef struct              // 16 bit Register
{
  ...
  uint16_t SPBOTP : 1;      // SPB Lock bit (OTP, Default = 1); SPBOTP/SPBLK
...
#endif  // defined(MXIC_SNOR_READ_LOCK_REGISTER_CMD)
#endif  // defined(MXIC_SNOR_READ_READ_LOCK_CONFIGURATION_CMD)
...
typedef struct              // SPB Lock Register
{
  uint8_t SPBLK : 1;        // SPB Lock bit
          // 0 = SPBs Protected (Password Protection Mode Default)
