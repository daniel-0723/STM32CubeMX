 ...
 * @file    MXIC_SNOR_2G.h
 * @brief   This file contains all information of Macronix 2G bit xSPI memory.
...
#ifndef __MXIC_SNOR_2G_H
#define __MXIC_SNOR_2G_H
 ...
 * 1.8V : MX66U2G43G, MX66U2G45G, MX66U2G45G54
 * 3.3V : MX66L2G43G, MX66L2G45G
 * Octal :
 * 1.8V : MX66UM2G45G, MX66UW2G345G, MX66UW2G345GX0
 *************************************************************************************************/
#define MX66UW2G345G
...
#if defined(MX66L2G43G) || defined(MX66L2G45G)
#define MXIC_SNOR_MEMORY_TYPE_ID            0x20
#elif defined(MX66U2G43G) || defined(MX66U2G45G)
#define MXIC_SNOR_MEMORY_TYPE_ID            0x25
#elif defined(MX66UM2G45G)
#define MXIC_SNOR_MEMORY_TYPE_ID            0x80
#elif defined(MX66UW2G345G)
#define MXIC_SNOR_MEMORY_TYPE_ID            0x84
#elif defined(MX66UW2G345GX0)
#define MXIC_SNOR_MEMORY_TYPE_ID            0x94
#elif defined(MX66U2G45G54)
#define MXIC_SNOR_MEMORY_TYPE_ID            0x95
#endif

#if defined(MX66L2G43G) || defined(MX66L2G45G)
#define MXIC_SNOR_MEMORY_CAPACITY_ID        0x1C
#elif defined(MX66U2G43G)  || defined(MX66U2G45G)   || defined(MX66U2G45G54) || \
      defined(MX66UM2G45G) || defined(MX66UW2G345G) || defined(MX66UW2G345GX0)
#define MXIC_SNOR_MEMORY_CAPACITY_ID        0x3C
#endif
 ...
 *************************************************************************************************/
#define MXIC_SNOR_FLASH_SIZE                (2U * (1024U / 8U) *1024U * 1024U)  // 2G bit = 256M Byte
...
#if defined(MX66U2G45G)  || defined(MX66L2G45G)   || defined(MX66U2G45G54) || \
    defined(MX66UM2G45G) || defined(MX66UW2G345G) || defined(MX66UW2G345GX0)
#define MXIC_SNOR_MAX_TIME_ERASE_CHIP       300000U
#elif defined(MX66U2G43G)
#define MXIC_SNOR_MAX_TIME_ERASE_CHIP       520000U
#elif defined(MX66L2G43G)
 ...
 * RPMC & Octal Flash not support QPI
 *************************************************************************************************/
#if defined(MX66U2G43G) || defined(MX66U2G45G) || defined(MX66U2G45G54) || \
    defined(MX66L2G43G) || defined(MX66L2G45G)
 ...
 * RPMC & Octal Flash not support QPI
 *************************************************************************************************/
#if defined(MX66UM2G45G) || defined(MX66UW2G345G) || defined(MX66UW2G345GX0)
...
#if defined(MX66UW2G345G) || defined(MX66UW2G345GX0)
...
#if !defined(MX66U2G43G) && \
    !defined(MX66L2G43G)  // Not support
...
#if !defined(MX66L2G45G)  // Not support
...
#if !defined(SUPPORT_OCTAL) && \
    !defined(MX66U2G45G54) // Not support
...
#elif DC_INDEX == 1
#if defined(MX66U2G43G) || defined(MX66L2G43G)
#define MXIC_SNOR_DUMMY_CLOCK_111        8    // 0x0B, 0x0C
#define MXIC_SNOR_DUMMY_CLOCK_112        8    // 0x3B, 0x3C
#define MXIC_SNOR_DUMMY_CLOCK_114        8    // 0x6B, 0x6C
...
#define MXIC_SNOR_DUMMY_CLOCK_144        4    // 0xEB, 0xEC
#define MXIC_SNOR_DUMMY_CLOCK_444        4    // 0xEB, 0xEC
#endif  // defined(MX66U2G43G) || defined(MX66L2G43G)
...
#define MXIC_SNOR_DUMMY_CLOCK_118       20      // Supported by MX66UW2G345G, MX66UW2G345GX0
#define MXIC_SNOR_DUMMY_CLOCK_888       20
#define MXIC_SNOR_DUMMY_CLOCK_888_DTR   20

#elif DC_INDEX == 1
#define MXIC_SNOR_DUMMY_CLOCK_111       8
#define MXIC_SNOR_DUMMY_CLOCK_118       18      // Supported by MX66UW2G345G, MX66UW2G345GX0
#define MXIC_SNOR_DUMMY_CLOCK_888       18
#define MXIC_SNOR_DUMMY_CLOCK_888_DTR   18

#elif DC_INDEX == 2
#define MXIC_SNOR_DUMMY_CLOCK_111       8
#define MXIC_SNOR_DUMMY_CLOCK_118       16      // Supported by MX66UW2G345G, MX66UW2G345GX0
#define MXIC_SNOR_DUMMY_CLOCK_888       16
#define MXIC_SNOR_DUMMY_CLOCK_888_DTR   16

#elif DC_INDEX == 3
#define MXIC_SNOR_DUMMY_CLOCK_111       8
#define MXIC_SNOR_DUMMY_CLOCK_118       14      // Supported by MX66UW2G345G, MX66UW2G345GX0
#define MXIC_SNOR_DUMMY_CLOCK_888       14
#define MXIC_SNOR_DUMMY_CLOCK_888_DTR   14

#elif DC_INDEX == 4
#define MXIC_SNOR_DUMMY_CLOCK_111       8
#define MXIC_SNOR_DUMMY_CLOCK_118       12      // Supported by MX66UW2G345G, MX66UW2G345GX0
#define MXIC_SNOR_DUMMY_CLOCK_888       12
#define MXIC_SNOR_DUMMY_CLOCK_888_DTR   12

#elif DC_INDEX == 5
#define MXIC_SNOR_DUMMY_CLOCK_111       8
#define MXIC_SNOR_DUMMY_CLOCK_118       10      // Supported by MX66UW2G345G, MX66UW2G345GX0
#define MXIC_SNOR_DUMMY_CLOCK_888       10
#define MXIC_SNOR_DUMMY_CLOCK_888_DTR   10

#elif DC_INDEX == 6
#define MXIC_SNOR_DUMMY_CLOCK_111       8
#define MXIC_SNOR_DUMMY_CLOCK_118       8       // Supported by MX66UW2G345G, MX66UW2G345GX0
#define MXIC_SNOR_DUMMY_CLOCK_888       8
#define MXIC_SNOR_DUMMY_CLOCK_888_DTR   8

#elif DC_INDEX == 7
#define MXIC_SNOR_DUMMY_CLOCK_111       8
#define MXIC_SNOR_DUMMY_CLOCK_118       6       // Supported by MX66UW2G345G, MX66UW2G345GX0
...
#if defined(MX66U2G45G) || defined(MX66U2G45G54) || \
    defined(MX66L2G45G)
