 ...
 * @file    MXIC_SNOR_16M.h
 * @brief   This file contains all information of Macronix 16M bit xSPI memory.
...
#ifndef __MXIC_SNOR_16M_H
#define __MXIC_SNOR_16M_H
 ...
 * 1.2V : MX25S1635F
 * 1.8V : MX25U1629F, MX25U1630F, MX25U1631F, MX25U1632F, MX25U1633F, MX25U1635E, MX25U1635F
 * 2.5V : MX25V1606F, MX25V1635F, MX25V16066
 * 3.3V : MX25L1605D, MX25L1606E, MX25L1608D, MX25L1608E, MX25L1633E, MX25L1635D, MX25L1635E
 *        MX25L1636D, MX25L1636E, MX25L1655D, MX25L1673E
 * Wide Range :
 *        MX25R1635F
 *************************************************************************************************/
#define MX25U1629F
...
#if defined(MX25V1606F) || defined(MX25V16066) || \
    defined(MX25L1605D) || defined(MX25L1606E) || defined(MX25L1608D) || defined(MX25L1608E)
#define MXIC_SNOR_MEMORY_TYPE_ID            0x20
#elif defined(MX25V1635F)
#define MXIC_SNOR_MEMORY_TYPE_ID            0x23
#elif defined(MX25L1633E) || defined(MX25L1635D) || defined(MX25L1636D) || defined(MX25L1673E)
#define MXIC_SNOR_MEMORY_TYPE_ID            0x24
#elif defined(MX25U1629F) || defined(MX25U1630F) || defined(MX25U1631F) || defined(MX25U1632F) || \
      defined(MX25U1633F) || defined(MX25U1635E) || defined(MX25U1635F) || \
      defined(MX25L1635E) || defined(MX25L1636E)
#define MXIC_SNOR_MEMORY_TYPE_ID            0x25
#elif defined(MX25L1655D)
#define MXIC_SNOR_MEMORY_TYPE_ID            0x26
#elif defined(MX25R1635F)
#define MXIC_SNOR_MEMORY_TYPE_ID            0x28
#elif defined(MX25S1635F)
#define MXIC_SNOR_MEMORY_TYPE_ID            0x2B
#endif

#if defined(MX25V1606F) || defined(MX25V1635F) || defined(MX25V16066) || \
    defined(MX25L1605D) || defined(MX25L1606E) || defined(MX25L1608D) || defined(MX25L1608E) || \
    defined(MX25L1633E) || defined(MX25L1635D) || defined(MX25L1635E) || defined(MX25L1636D) || \
    defined(MX25L1636E) || defined(MX25L1655D) || defined(MX25L1673E) || \
    defined(MX25R1635F)
#define MXIC_SNOR_MEMORY_CAPACITY_ID        0x15
#elif defined(MX25S1635F)
#define MXIC_SNOR_MEMORY_CAPACITY_ID        0x25
#elif defined(MX25U1629F) || defined(MX25U1630F) || defined(MX25U1631F) || defined(MX25U1632F) || \
      defined(MX25U1633F) || defined(MX25U1635E) || defined(MX25U1635F)
#define MXIC_SNOR_MEMORY_CAPACITY_ID        0x35
#endif
 ...
 *************************************************************************************************/
#define MXIC_SNOR_FLASH_SIZE                ((16U / 8U) * 1024U * 1024U)    // 16M bit = 2M Byte
...
#if defined(MX25U1629F) || defined(MX25U1630F)
#define MXIC_SNOR_MAX_TIME_ERASE_CHIP       9000U
#elif defined(MX25U1632F)
#define MXIC_SNOR_MAX_TIME_ERASE_CHIP       12500U
#elif defined(MX25U1631F) || defined(MX25U1635E) || defined(MX25U1635F) || \
      defined(MX25L1606E) || defined(MX25L1608E) || defined(MX25L1633E) || defined(MX25L1673E)
#define MXIC_SNOR_MAX_TIME_ERASE_CHIP       20000U
#elif defined(MX25L1605D) || defined(MX25L1608D) || defined(MX25L1635D) || defined(MX25L1635E) || \
      defined(MX25L1636D) || defined(MX25L1636E) || defined(MX25L1655D)
#define MXIC_SNOR_MAX_TIME_ERASE_CHIP       30000U
#elif defined(MX25U1633F) || \
      defined(MX25V1635F)
#define MXIC_SNOR_MAX_TIME_ERASE_CHIP       38000U
#elif defined(MX25V1606F)
#define MXIC_SNOR_MAX_TIME_ERASE_CHIP       55000U
#elif defined(MX25V16066)
#define MXIC_SNOR_MAX_TIME_ERASE_CHIP       56000U
#elif defined(MX25R1635F)
#define MXIC_SNOR_MAX_TIME_ERASE_CHIP       60000U
#elif defined(MX25S1635F)
#define MXIC_SNOR_MAX_TIME_ERASE_CHIP       506250U
#endif
 ...
 *************************************************************************************************/
#if defined(MX25L1605D) || defined(MX25L1606E) || defined(MX25L1608D) || defined(MX25L1608E) || \
    defined(MX25L1633E) || defined(MX25L1635D) || defined(MX25L1636D) || defined(MX25L1655D) || \
    defined(MX25L1673E)
#define MXIC_SNOR_SECURE_OTP_SIZE           (512U / 8U)         // Secured OTP Memory 512 bit = 64 Byte
#elif defined(MX25U1630F) || defined(MX25U1631F) || defined(MX25U1635E) || defined(MX25U1635F) || \
      defined(MX25L1635E) || defined(MX25L1636E)
#define MXIC_SNOR_SECURE_OTP_SIZE           (4U * 1024U / 8U)   // Secured OTP Memory 4K bit = 512 Byte
#elif defined(MX25S1635F) || \
      defined(MX25U1629F) || defined(MX25U1632F) || defined(MX25U1633F) || \
      defined(MX25V1635F) || \
      defined(MX25R1635F)
 ...
 * RPMC & Octal Flash not support QPI
 *************************************************************************************************/
#if defined(MX25U1629F) || defined(MX25U1630F) || defined(MX25U1631F) || defined(MX25U1632F) || \
    defined(MX25U1635E) || defined(MX25U1635F)
 ...
 *************************************************************************************************/
    ...
    !defined(MX25V1606F) && !defined(MX25V16066) && \
    !defined(MX25L1605D) && !defined(MX25L1606E) && !defined(MX25L1608D) && !defined(MX25L1608E) && \
    !defined(MX25L1636D)  // Not support
#define SUPPORT_PERFORMANCE_ENHANCE_READ        // performance enhance indicator
#endif

#if defined(MX25S1635F) || \
    defined(MX25U1629F) || defined(MX25U1630F) || defined(MX25U1630F) || defined(MX25U1631F) || \
    defined(MX25U1632F) || defined(MX25U1633F) || defined(MX25U1635E) || defined(MX25U1635F) || \
    defined(MX25V1635F) || \
    defined(MX25R1635F)
 ...
 *************************************************************************************************/
#if defined(MX25U1632F) || \
    defined(MX25V1606F) || defined(MX25V16066)
#define SUPPORT_FACTORY_MODE                    // Factory Mode
#endif

#if defined(MX25S1635F) || \
    defined(MX25U1629F) || defined(MX25U1630F) || defined(MX25U1631F) || defined(MX25U1632F) || \
    defined(MX25U1633F) || defined(MX25U1635E) || defined(MX25U1635F) || \
    defined(MX25V1635F) || \
    defined(MX25R1635F)
...
#if defined(MX25L1605D) || defined(MX25L1608D) || defined(MX25L1635D) || defined(MX25L1636D) || \
    defined(MX25L1655D)
 ...
 *************************************************************************************************/
#if !defined(MX25V1606F) && \
    !defined(MX25L1605D) && !defined(MX25L1606E) && !defined(MX25L1608D) && !defined(MX25L1608E) && \
    !defined(MX25L1633E) && !defined(MX25L1635D) && !defined(MX25L1635E) && !defined(MX25L1636D) && \
    !defined(MX25L1636E) && !defined(MX25L1655D) && !defined(MX25L1673E)  // Not support
 ...
 *************************************************************************************************/
#if !defined(MX25S1635F) && \
    !defined(MX25L1605D) && !defined(MX25L1608D) && !defined(MX25L1608E) && !defined(MX25L1633E) && \
    !defined(MX25L1635D) && !defined(MX25L1635E) && !defined(MX25L1636D) && !defined(MX25L1636E) && \
    !defined(MX25L1655D)  // Not support
...
#if defined(MX25U1630F) || defined(MX25U1631F) || defined(MX25U1635E) || defined(MX25U1635F)
...
#if defined(MX25L1636D)
#define MXIC_SNOR_PAGE_PROG_114_CMD                     0x32   // QPP, 1I4P Page Program 3 Byte Address; 1-1-4
#endif

#if !defined(SUPPORT_OCTAL) && \
    !defined(MX25V1606F) && !defined(MX25V16066) && \
    !defined(MX25L1605D) && !defined(MX25L1606E) && !defined(MX25L1608D) && !defined(MX25L1608E)  // Not support
...
#if !defined(MX25L1655D)   // Not support
...
#if defined(MX25L1605D) || defined(MX25L1608D) || defined(MX25L1633E) || defined(MX25L1635D) || \
    defined(MX25L1635E) || defined(MX25L1636D) || defined(MX25L1636E) || defined(MX25L1655D) || \
    defined(MX25L1673E)
#define MXIC_SNOR_READ_ELECTRONIC_MANFACTURER_ID_CMD2   0xEF   // REMS2, Read Electronic Manufacturer ID & Device ID; 1-2-2
#endif

#if defined(MX25L1633E) || defined(MX25L1635D) || defined(MX25L1635E) || defined(MX25L1636D) || \
    defined(MX25L1636E) || defined(MX25L1655D) || defined(MX25L1673E)
...
#if defined(MX25U1630F) || defined(MX25U1631F) || defined(MX25U1635E) || defined(MX25U1635F)
#define MXIC_SNOR_SINGLE_BLOCK_LOCK_CMD                 0x36   // SBLK, Single Block Lock; 1-1-0 + 3/4 Byte Address; 1-1-0/4-4-0
#define MXIC_SNOR_SINGLE_BLOCK_UNLOCK_CMD               0x39   // SBULK, Single Block Un-Lock; 1-1-0 + 3/4 Byte Address; 1-1-0/4-4-0
#define MXIC_SNOR_READ_BLOCK_LOCK_STATUS_CMD            0x3C   // RDBLOCK, Read Block Lock Status; 1-1-1 + 3/4 Byte Address; 1-1-1/4-4-4
...
#if defined(MX25U1629F) || defined(MX25U1632F)
...
//#else
#if !defined(MX25V16066)  // Not support
...
#define MXIC_SNOR_DEEP_POWER_DOWN_CMD                   0xB9   // DP, Deep power down; 1-0-0/4-0-0/8S-0-0/8D-0-0
    ...
    !defined(MX25U1629F) && !defined(MX25U1632F) && !defined(MX25U1633F) && \
    !defined(MX25V1635F) && \
    !defined(MX25R1635F)  // Not support
...
#if defined(SUPPORT_OCTAL) || \
    defined(MX25V1606F) || defined(MX25V16066) || \
    defined(MX25L1606E) || defined(MX25L1608E) || defined(MX25L1655D)
// Empty, Status Register not support CPM/QE
#elif defined(MX25L1605D) || defined(MX25L1608D)
...
#if defined(MX25R1635F)     // Support RDCR command read out CR1 & CR2
...
#if !defined(MX25L1608D) && !defined(MX25L1608E)  // Not support
