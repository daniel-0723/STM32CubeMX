 ...
 * @file    MXIC_SNOR_32M.h
 * @brief   This file contains all information of Macronix 32M bit xSPI memory.
...
#ifndef __MXIC_SNOR_32M_H
#define __MXIC_SNOR_32M_H
 ...
 * 1.8V : MX25U3229F, MX25U3230F, MX25U3232F, MX25U3233F, MX25U3235E, MX25U3235F, MX25U3273F
 * 2.5V : MX25V3233F
 * 3.3V : MX25L3205,  MX25L3205A, MX25L3205D, MX25L3206E, MX25L3208D, MX25L3208E, MX25L3225D
 *        MX25L3233F, MX25L3235D, MX25L3235E, MX25L3235F, MX25L3236D, MX25L3236F, MX25L3237D
 *        MX25L3239E, MX25L3254E, MX25L3255D, MX25L3255E, MX25L3258D, MX25L3273E, MX25L3273F
 *        MX25L3275E
 * Wide Range :
 *        MX25R3235F
 * Security :
...
#if defined(MX25L3205)  || defined(MX25L3205A) || defined(MX25L3205D) || defined(MX25L3206E) || \
    defined(MX25L3208D) || defined(MX25L3208E) || defined(MX25L3233F) || defined(MX25L3235E) || \
    defined(MX25L3235F) || defined(MX25L3236F) || defined(MX25L3273E) || defined(MX25L3273F) || \
    defined(MX25L3275E)
#define MXIC_SNOR_MEMORY_TYPE_ID            0x20
#elif defined(MX25V3233F)
#define MXIC_SNOR_MEMORY_TYPE_ID            0x23
#elif defined(MX25U3229F) || defined(MX25U3230F) || defined(MX25U3232F) || defined(MX25U3233F) || \
      defined(MX25U3235E) || defined(MX25U3235F) || defined(MX25U3273F) || \
      defined(MX25L3239E)
#define MXIC_SNOR_MEMORY_TYPE_ID            0x25
#elif defined(MX25R3235F)
#define MXIC_SNOR_MEMORY_TYPE_ID            0x28
#elif defined(MX25L3225D) || defined(MX25L3235D) || defined(MX25L3236D) || defined(MX25L3237D)
#define MXIC_SNOR_MEMORY_TYPE_ID            0x5E
#elif defined(MX76U3233F)
#define MXIC_SNOR_MEMORY_TYPE_ID            0x76
#elif defined(MX25L3254E) || defined(MX25L3255D) || defined(MX25L3255E) || defined(MX25L3258D)
#define MXIC_SNOR_MEMORY_TYPE_ID            0x9E
#endif

#if defined(MX25V3233F) || \
    defined(MX25L3205)  || defined(MX25L3205A) || defined(MX25L3205D) || defined(MX25L3206E) || \
    defined(MX25L3208D) || defined(MX25L3208E) || defined(MX25L3225D) || defined(MX25L3233F) || \
    defined(MX25L3235D) || defined(MX25L3235E) || defined(MX25L3235F) || defined(MX25L3236D) || \
    defined(MX25L3236F) || defined(MX25L3237D) || defined(MX25L3254E) || defined(MX25L3255D) || \
    defined(MX25L3255E) || defined(MX25L3258D) || defined(MX25L3273E) || defined(MX25L3273F) || \
    defined(MX25L3275E) || \
    defined(MX25R3235F)
#define MXIC_SNOR_MEMORY_CAPACITY_ID        0x16
#elif defined(MX25U3229F) || defined(MX25U3230F) || defined(MX25U3232F) || defined(MX25U3233F) || \
      defined(MX25U3235E) || defined(MX25U3235F) || defined(MX25U3273F) || \
      defined(MX25L3239E) || \
      defined(MX76U3233F)
#define MXIC_SNOR_MEMORY_CAPACITY_ID        0x36
#endif
 ...
 *************************************************************************************************/
#define MXIC_SNOR_FLASH_SIZE                ((32U / 8U) * 1024U * 1024U)    // 32M bit = 4M Byte
...
#if defined(MX25U3229F) || defined(MX25U3230F)
#define MXIC_SNOR_MAX_TIME_ERASE_CHIP       20000U
#elif defined(MX25U3232F)
#define MXIC_SNOR_MAX_TIME_ERASE_CHIP       25000U
#elif defined(MX25L3233F) || defined(MX25L3236F) || defined(MX25L3273F)
#define MXIC_SNOR_MAX_TIME_ERASE_CHIP       30000U
#elif defined(MX25U3235E) || \
      defined(MX25L3206E) || defined(MX25L3208E)
#define MXIC_SNOR_MAX_TIME_ERASE_CHIP       40000U
#elif defined(MX25U3235F) || \
      defined(MX25L3205D) || defined(MX25L3208D) || defined(MX25L3225D) || defined(MX25L3235D) || \
      defined(MX25L3235E) || defined(MX25L3235F) || defined(MX25L3236D) || defined(MX25L3237D) || \
      defined(MX25L3239E) || defined(MX25L3254E) || defined(MX25L3255D) || defined(MX25L3255E) || \
      defined(MX25L3258D) || defined(MX25L3273E) || defined(MX25L3275E)
#define MXIC_SNOR_MAX_TIME_ERASE_CHIP       50000U
#elif defined(MX25U3233F) || defined(MX25U3273F) || \
      defined(MX25V3233F) || \
      defined(MX76U3233F)
#define MXIC_SNOR_MAX_TIME_ERASE_CHIP       76000U
#elif defined(MX25R3235F)
#define MXIC_SNOR_MAX_TIME_ERASE_CHIP       120000U
#elif defined(MX25L3205) || defined(MX25L3205A)
#define MXIC_SNOR_MAX_TIME_ERASE_CHIP       128000U
#endif

/**************************************************************************************************
 * Macronix xSPI-NOR Flash Secured OTP/Additional memory support
 * MXIC_SNOR_SECURE_OTP_SIZE is nameing. This area memory may can be erase/program isn't OTP, it's
 * device dependents (Reference to data sheet). Use command 0xB1, 0xC1, 0x2F.
 * Additional memory could be erase/program, Use command 0xA5, 0xB5.
 *************************************************************************************************/
#if defined(MX25L3205D) || defined(MX25L3206E) || defined(MX25L3208D) || defined(MX25L3208E)
#define MXIC_SNOR_SECURE_OTP_SIZE           (512U / 8U)         // Secured OTP Memory 512 bit = 64 Byte
#elif defined(MX25U3230F) || defined(MX25U3235E) || defined(MX25U3235F) || \
      defined(MX25L3225D) || defined(MX25L3233F) || defined(MX25L3235D) || defined(MX25L3235E) || \
      defined(MX25L3235F) || defined(MX25L3236D) || defined(MX25L3236F) || defined(MX25L3237D) || \
      defined(MX25L3239E) || defined(MX25L3254E) || defined(MX25L3255D) || defined(MX25L3255E) || \
      defined(MX25L3258D) || defined(MX25L3273E) || defined(MX25L3273F) || defined(MX25L3275E)
#define MXIC_SNOR_SECURE_OTP_SIZE           (4U * 1024U / 8U)   // Secured OTP Memory 4K bit = 512 Byte
#elif defined(MX25U3229F) || defined(MX25U3232F) || defined(MX25U3233F) || defined(MX25U3273F) || \
      defined(MX25V3233F) || \
      defined(MX25R3235F) || \
      defined(MX76U3233F)
 ...
 * RPMC & Octal Flash not support QPI
 *************************************************************************************************/
#if defined(MX25U3229F) || defined(MX25U3230F) || defined(MX25U3232F) || defined(MX25U3235E) || \
    defined(MX25U3235F) || \
    defined(MX25L3239E)
...
#if defined(MX25L3205) || defined(MX25L3205A)
 ...
 *************************************************************************************************/
    ...
    !defined(MX25L3205)  && !defined(MX25L3205A) && !defined(MX25L3205D) && !defined(MX25L3206E) && \
    !defined(MX25L3208D) && !defined(MX25L3208E)  // Not support
#define SUPPORT_PERFORMANCE_ENHANCE_READ        // performance enhance indicator
#endif

#if defined(MX25U3229F) || defined(MX25U3230F) || defined(MX25U3232F) || defined(MX25U3233F) || \
    defined(MX25U3235E) || defined(MX25U3235F) || defined(MX25U3273F) || \
    defined(MX25V3233F) || \
    defined(MX25L3233F) || defined(MX25L3235F) || defined(MX25L3236F) || defined(MX25L3239E) || \
    defined(MX25L3273F) || \
    defined(MX25R3235F) || \
    defined(MX76U3233F)
 ...
 *************************************************************************************************/
#if defined(MX25U3229F) || defined(MX25U3232F)
...
#if defined(MX25L3205D) || defined(MX25L3208D) || defined(MX25L3225D) || defined(MX25L3235D) || \
    defined(MX25L3235E) || defined(MX25L3236D) || defined(MX25L3237D) || defined(MX25L3254E) || \
    defined(MX25L3255E) || defined(MX25L3255D) || defined(MX25L3258D) || defined(MX25L3273E) || \
    defined(MX25L3275E)
 ...
 *************************************************************************************************/
#if !defined(MX25L3205)  && !defined(MX25L3205A) && !defined(MX25L3205D) && !defined(MX25L3206E) && \
    !defined(MX25L3208D) && !defined(MX25L3208E) && !defined(MX25L3225D) && !defined(MX25L3235D) && \
    !defined(MX25L3236D) && !defined(MX25L3237D) && !defined(MX25L3255D) && !defined(MX25L3258D)  // Not support
 ...
 *************************************************************************************************/
#if !defined(MX25L3205)  && !defined(MX25L3205A) && !defined(MX25L3205D) && !defined(MX25L3208D) && \
    !defined(MX25L3208E) && !defined(MX25L3225D) && !defined(MX25L3235D) && !defined(MX25L3236D) && \
    !defined(MX25L3237D) && !defined(MX25L3255D) && !defined(MX25L3258D)  // Not support
...
#if defined(MX25U3229F) || defined(MX25U3230F) || defined(MX25U3232F) || defined(MX25U3235E) || \
    defined(MX25U3235F) || \
    defined(MX25L3235E) || defined(MX25L3239E) || defined(MX25L3254E) || defined(MX25L3255E) || \
    defined(MX25L3273E) || \
    defined(MX25L3275E)
...
#if defined(MX25L3254E) || defined(MX25L3255D) || defined(MX25L3255E) || defined(MX25L3258D)
#define SUPPORT_BLOCK_PROTECTION                // 64K Block write lock protection command
#endif

#if !defined(MX25L3205) && !defined(MX25L3205A)  // Not support
...
#define MXIC_SNOR_FAST_READ_114_CMD                     0x6B    // QREAD, 1I 4O Read 3/4 Byte Address; 1-1-4
    ...
    defined(MX25U3235F) || \
    defined(MX25L3235E) || defined(MX25L3239E) || defined(MX25L3254E) || defined(MX25L3255E) || \
    defined(MX25L3273E) || defined(MX25L3275E)
...
#if defined(MX25U3230F) || defined(MX25U3235E) || defined(MX25U3235F) || \
    defined(MX25L3239E)
...
#if !defined(MX25L3255D) && !defined(MX25L3258D)  // Not support
...
#endif
#if defined(MX25L3225D) || defined(MX25L3235D) || defined(MX25L3235E) || defined(MX25L3236D) || \
    defined(MX25L3237D) || defined(MX25L3254E) || defined(MX25L3255D) || defined(MX25L3255E) || \
    defined(MX25L3258D) || defined(MX25L3273E) || defined(MX25L3275E)
...
#endif
#endif  // Exclusive command 0x36, 0x38, 0x3C
...
#if defined(MX25L3254E) || defined(MX25L3255E)
...
#if defined(MX25L3254E) || defined(MX25L3255E) || defined(MX25L3258D)
...
#if !defined(MX25U3229F) && !defined(MX25U3232F) && !defined(MX25U3233F) && !defined(MX25U3273F) && \
    !defined(MX25V3233F) && \
    !defined(MX25R3235F) && \
    !defined(MX76U3233F)  // Not support
...
#if defined(MX25L3255D) || defined(MX25L3258D)
// Empty, Status Register not support BP, Block Protection bit
#elif defined(MX25L3205) || defined(MX25L3205A)
#define MXIC_SNOR_SR_BP         0x1CU     /*!< Block protected against program and erase operations, 3 bit */

#else
#define MXIC_SNOR_SR_BP         0x3CU     /*!< Block protected against program and erase operations, 4 bit */
#endif

#if defined(SUPPORT_OCTAL) || \
    defined(MX25L3206E) || defined(MX25L3208E) || defined(MX25L3255D) || defined(MX25L3258D)
// Empty, Status Register not support QE, Quad Enable bit

#elif defined(MX25L3205) || defined(MX25L3205A)
#define MXIC_SNOR_SR_Error      0x40U     /*!< Program/Erase error; 1 = Error */
...
#define MXIC_SNOR_SR_QE         0x40U     /*!< QE bit; Quad IO mode enabled if =1 */
    ...
    !defined(MX25U3273F) && \
    !defined(MX25L3255D) && !defined(MX25L3258D) && !defined(MX25L3273F)  // Not support
...
#if MXIC_SNOR_SR_BP == 0x1CU
  uint8_t BP : 3;           // Block protected against program and erase operations
  uint8_t Reserved : 1;
#elif MXIC_SNOR_SR_BP == 0x3CU
  uint8_t BP : 4;           // Block protected against program and erase operations
#else
  uint8_t Reserved : 4;
#endif

#ifdef MXIC_SNOR_SR_Error
  uint8_t Error : 1;        // Program/Erase error; 1 = Error
#elif defined(MXIC_SNOR_SR_CPM)
...
#if defined(MX25U3233F) || defined(MX25U3273F) || \
    defined(MX25V3233F) || \
    defined(MX25L3235E) || defined(MX25L3239E) || defined(MX25L3254E) || defined(MX25L3255E) || \
    defined(MX25L3273E) || defined(MX25L3275E) || \
    defined(MX25R3235F) || \
...
#elif defined(MX25L3233F) || defined(MX25L3235F) || defined(MX25L3236F) || defined(MX25L3273F)
...
#elif defined(MX25U3233F) || defined(MX25U3273F) || \
      defined(MX25V3233F) || \
      defined(MX25L3233F) || defined(MX25L3235F) || defined(MX25L3236F) || defined(MX25L3273F) || \
      defined(MX25R3235F) || \
      defined(MX76U3233F)
#define MXIC_SNOR_CR_DC         0x40U     /*!< Dummy Clock Cycles setting, 1 bit @ bit 6 */

#elif defined(MX25L3235E) || defined(MX25L3239E) || defined(MX25L3254E) || defined(MX25L3255E) || \
      defined(MX25L3273E) || defined(MX25L3275E)
...
#if defined(MX25R3235F)    // Support RDCR command read out CR1 & CR2
...
#if !defined(MX25L3208D) && !defined(MX25L3208E) && !defined(MX25L3258D) // Not support
#define MXIC_SNOR_SCUR_LDSO             ((uint8_t)0x02)    /*!< Indicate if Lock-down Secured OTP */
#endif
#endif  // MXIC_SNOR_SECURE_OTP_SIZE

#if defined(MX25L3258D)
#define MXIC_SNOR_SCUR_RLB              ((uint8_t)0x04)    /*!< Read-Lock bit for 128KB */

#elif !defined(MX25L3205D) && !defined(MX25L3206E) && !defined(MX25L3208D) && !defined(MX25L3208E) && \
      !defined(MX25L3225D) && !defined(MX25L3235D) && !defined(MX25L3235E) && !defined(MX25L3236D) && \
      !defined(MX25L3237D) && !defined(MX25L3254E) && !defined(MX25L3255D) && !defined(MX25L3255E) && \
      !defined(MX25L3273E) && !defined(MX25L3275E)  // Not support
...
#if !defined(MX25L3205D) && !defined(MX25L3206E) && !defined(MX25L3208D) && !defined(MX25L3208E) && \
    !defined(MX25L3225D) && !defined(MX25L3235D) && !defined(MX25L3236D) && !defined(MX25L3237D) && \
    !defined(MX25L3255D) && !defined(MX25L3258D)  // Not support
...
#ifdef  MXIC_SNOR_SCUR_RLB
  uint8_t RLB : 1;          // Read-Lock bit for 128KB; 1 = Read Locked
#elif defined(MXIC_SNOR_SCUR_PSB)
...
typedef struct              // 16 bit Register
{
  ...
  uint16_t SPBOTP : 1;      // SPB Lock bit (OTP, Default = 1)
